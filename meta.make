...
contests_meta.c contests_meta.h : $(META_CC) ./include/ejudge/contests.h
...
super-serve_meta.c super-serve_meta.h : $(META_CC) ./include/ejudge/super-serve.h
...
prepare_meta.c prepare_meta.h : $(META_CC) ./include/ejudge/prepare.h
...
super_html_6_meta.c super_html_6_meta.h : $(META_CC) ./include/ejudge/super_html_6.h
...
super_run_packet_meta.c super_run_packet_meta.h : $(META_CC) ./include/ejudge/super_run_packet.h
...
problem_config_meta.c problem_config_meta.h : $(META_CC) ./include/ejudge/problem_config.h
...
polygon_packet_meta.c polygon_packet_meta.h : $(META_CC) ./include/ejudge/polygon_packet.h
	$(META_CC) $(META_CC_FLAGS) ./include/ejudge/polygon_packet.h -o polygon_packet.out --force-h --meta --meta-struct polygon_packet

ej_import_packet_meta.c ej_import_packet_meta.h : $(META_CC) ./include/ejudge/ej_import_packet.h
