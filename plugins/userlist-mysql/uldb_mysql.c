...
check_func(void *data)
{
  ...
  while (version >= 0) {
    ...
    case 16:
      ...
      break;
    case 17:
      if (mi->simple_fquery(md, "ALTER TABLE %sconfig MODIFY COLUMN config_key VARCHAR(64) NOT NULL, MODIFY COLUMN config_val VARCHAR(64) ;", md->table_prefix) < 0)
        return -1;
      break;
    case 18:
      if (mi->simple_fquery(md, "ALTER TABLE %slogins MODIFY COLUMN login VARCHAR(64) NOT NULL, MODIFY COLUMN email VARCHAR(128), MODIFY COLUMN password VARCHAR(128) ;", md->table_prefix) < 0)
        return -1;
      break;
    case 19:
      if (mi->simple_fquery(md, "ALTER TABLE %scookies MODIFY COLUMN cookie VARCHAR(64) NOT NULL, MODIFY COLUMN ip VARCHAR(64) NOT NULL ;", md->table_prefix) < 0)
        return -1;
      break;
    case 20:
      if (mi->simple_fquery(md, "ALTER TABLE %susers MODIFY COLUMN username VARCHAR(512) DEFAULT NULL, MODIFY COLUMN password VARCHAR(128) DEFAULT NULL, MODIFY COLUMN inst VARCHAR(512) DEFAULT NULL, MODIFY COLUMN inst_en VARCHAR (512) DEFAULT NULL, MODIFY COLUMN instshort VARCHAR (512) DEFAULT NULL, MODIFY COLUMN instshort_en VARCHAR (512) DEFAULT NULL, MODIFY COLUMN fac VARCHAR(512) DEFAULT NULL, MODIFY COLUMN fac_en VARCHAR (512) DEFAULT NULL, MODIFY COLUMN facshort VARCHAR (512) DEFAULT NULL, MODIFY COLUMN facshort_en VARCHAR (512) DEFAULT NULL, MODIFY COLUMN homepage VARCHAR (512) DEFAULT NULL, MODIFY COLUMN phone VARCHAR (512) DEFAULT NULL, MODIFY COLUMN city VARCHAR (512) DEFAULT NULL, MODIFY COLUMN city_en VARCHAR (512) DEFAULT NULL, MODIFY COLUMN region VARCHAR (512) DEFAULT NULL, MODIFY COLUMN area VARCHAR (512) DEFAULT NULL, MODIFY COLUMN zip VARCHAR (512) DEFAULT NULL, MODIFY COLUMN street VARCHAR (512) DEFAULT NULL, MODIFY COLUMN country VARCHAR (512) DEFAULT NULL, MODIFY COLUMN country_en VARCHAR (512) DEFAULT NULL, MODIFY COLUMN location VARCHAR (512) DEFAULT NULL, MODIFY COLUMN spelling VARCHAR (512) DEFAULT NULL, MODIFY COLUMN printer VARCHAR (512) DEFAULT NULL, MODIFY COLUMN languages VARCHAR (512) DEFAULT NULL, MODIFY COLUMN exam_id VARCHAR (512) DEFAULT NULL, MODIFY COLUMN exam_cypher VARCHAR (512) DEFAULT NULL, MODIFY COLUMN field0 VARCHAR(512) DEFAULT NULL, MODIFY COLUMN field1 VARCHAR(512) DEFAULT NULL, MODIFY COLUMN field2 VARCHAR(512) DEFAULT NULL, MODIFY COLUMN field3 VARCHAR(512) DEFAULT NULL, MODIFY COLUMN field4 VARCHAR(512) DEFAULT NULL, MODIFY COLUMN field5 VARCHAR(512) DEFAULT NULL, MODIFY COLUMN field6 VARCHAR(512) DEFAULT NULL, MODIFY COLUMN field7 VARCHAR(512) DEFAULT NULL, MODIFY COLUMN field8 VARCHAR(512) DEFAULT NULL, MODIFY COLUMN field9 VARCHAR(512) DEFAULT NULL, MODIFY COLUMN avatar_store VARCHAR(512) DEFAULT NULL, MODIFY COLUMN avatar_id VARCHAR(512) DEFAULT NULL, MODIFY COLUMN avatar_suffix VARCHAR(32) DEFAULT NULL ;", md->table_prefix) < 0)
        return -1;
      break;
    case 21:
      if (mi->simple_fquery(md, "ALTER TABLE %smembers MODIFY COLUMN firstname VARCHAR(512) DEFAULT NULL, MODIFY COLUMN firstname_en VARCHAR(512) DEFAULT NULL, MODIFY COLUMN middlename VARCHAR(512) DEFAULT NULL, MODIFY COLUMN middlename_en VARCHAR(512) DEFAULT NULL, MODIFY COLUMN surname VARCHAR(512) DEFAULT NULL, MODIFY COLUMN surname_en VARCHAR(512) DEFAULT NULL, MODIFY COLUMN grp VARCHAR(512) DEFAULT NULL, MODIFY COLUMN grp_en VARCHAR(512) DEFAULT NULL, MODIFY COLUMN occupation VARCHAR(512) DEFAULT NULL, MODIFY COLUMN occupation_en VARCHAR(512) DEFAULT NULL, MODIFY COLUMN discipline VARCHAR(512) DEFAULT NULL, MODIFY COLUMN email VARCHAR(512) DEFAULT NULL, MODIFY COLUMN homepage VARCHAR(512) DEFAULT NULL, MODIFY COLUMN phone VARCHAR(512) DEFAULT NULL, MODIFY COLUMN inst VARCHAR(512) DEFAULT NULL, MODIFY COLUMN inst_en VARCHAR(512) DEFAULT NULL, MODIFY COLUMN instshort VARCHAR(512) DEFAULT NULL, MODIFY COLUMN instshort_en VARCHAR(512) DEFAULT NULL, MODIFY COLUMN fac VARCHAR(512) DEFAULT NULL, MODIFY COLUMN fac_en VARCHAR(512) DEFAULT NULL, MODIFY COLUMN facshort VARCHAR(512) DEFAULT NULL, MODIFY COLUMN facshort_en VARCHAR(512) DEFAULT NULL ;", md->table_prefix) < 0)
        return -1;
      break;
    case 22:
      if (mi->simple_fquery(md, "ALTER TABLE %sejgroups MODIFY COLUMN group_name VARCHAR(128) NOT NULL UNIQUE KEY, MODIFY COLUMN description VARCHAR(512) DEFAULT NULL ;", md->table_prefix) < 0)
        return -1;
      break;
    case 23:
      if (mi->simple_fquery(md, "ALTER TABLE %sgroupmembers MODIFY COLUMN rights VARCHAR(512) DEFAULT NULL ;", md->table_prefix) < 0)
        return -1;
      break;
    case 24:
      if (mi->simple_fquery(md, "ALTER TABLE %sapikeys MODIFY COLUMN token VARCHAR(64) NOT NULL PRIMARY KEY, MODIFY COLUMN secret VARCHAR(64) NOT NULL UNIQUE KEY, MODIFY COLUMN payload VARCHAR(1024) DEFAULT NULL, MODIFY COLUMN origin VARCHAR(128) DEFAULT NULL ;", md->table_prefix) < 0)
        return -1;
      break;
    default:
      version = -1;
