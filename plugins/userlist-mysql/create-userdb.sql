...
CREATE TABLE %susers
       ...
       city_en VARCHAR (512) DEFAULT NULL,
       ...
       country_en VARCHAR (512) DEFAULT NULL,
       location VARCHAR (512) DEFAULT NULL,
       spelling VARCHAR (512) DEFAULT NULL,
       printer VARCHAR (512) DEFAULT NULL,
       languages VARCHAR (512) DEFAULT NULL,
       exam_id VARCHAR (512) DEFAULT NULL,
       exam_cypher VARCHAR (512) DEFAULT NULL,
       field0 VARCHAR(512) DEFAULT NULL,
