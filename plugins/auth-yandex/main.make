...
AUTH_YANDEX_CFILES = auth_yandex.c

CFILES = $(AUTH_YANDEX_CFILES)
HFILES =
...
deps.make : $(CFILES) $(HFILES)
	../../cdeps -v AUTH_YANDEX_OFILES -I ../.. -I ../../include -g -c '$$(CC) $$(CFLAGS) -DPIC -fPIC' $(AUTH_YANDEX_CFILES) > deps.make

include deps.make

auth_yandex.so : $(AUTH_YANDEX_OFILES)
