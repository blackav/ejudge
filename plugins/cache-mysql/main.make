...
CACHE_MYSQL_CFILES = cache_mysql.c

CFILES = $(CACHE_MYSQL_CFILES)
HFILES =
...
deps.make : $(CFILES) $(HFILES)
	../../cdeps -v CACHE_MYSQL_OFILES -I ../.. -I ../../include -g -c '$$(CC) $$(CFLAGS) -DPIC -fPIC' $(CACHE_MYSQL_CFILES) > deps.make

include deps.make

cache_mysql.so : $(CACHE_MYSQL_OFILES)
