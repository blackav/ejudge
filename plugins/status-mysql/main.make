...
STATUS_MYSQL_CFILES = status_mysql.c

CFILES = $(STATUS_MYSQL_CFILES)
HFILES =
...
deps.make : $(CFILES) $(HFILES)
	../../cdeps -v STATUS_MYSQL_OFILES -I ../.. -I ../../include -g -c '$$(CC) $$(CFLAGS) -DPIC -fPIC' $(STATUS_MYSQL_CFILES) > deps.make

include deps.make

status_mysql.so : $(STATUS_MYSQL_OFILES)
