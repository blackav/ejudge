...
CFILES = status_mongo.c

PLUGINS = status_mongo.so
...
deps.make : $(CFILES) $(HFILES)
	../../cdeps -v STATUS_MONGO_OFILES -I ../../include -g -c '$$(CC) $$(CFLAGS) -DPIC -fPIC' $(CFILES) > deps.make

include deps.make

status_mongo.so : $(STATUS_MONGO_OFILES)
