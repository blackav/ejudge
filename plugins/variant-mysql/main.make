...
VARIANT_MYSQL_CFILES = variant_mysql.c

CFILES = $(VARIANT_MYSQL_CFILES)
HFILES =
...
deps.make : $(CFILES) $(HFILES)
	../../cdeps -v VARIANT_MYSQL_OFILES -I ../.. -I ../../include -g -c '$$(CC) $$(CFLAGS) -DPIC -fPIC' $(VARIANT_MYSQL_CFILES) > deps.make

include deps.make

variant_mysql.so : $(VARIANT_MYSQL_OFILES)
