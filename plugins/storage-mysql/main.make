...
STORAGE_MYSQL_CFILES = storage_mysql.c

CFILES = $(STORAGE_MYSQL_CFILES)
HFILES =
...
deps.make : $(CFILES) $(HFILES)
	../../cdeps -v STORAGE_MYSQL_OFILES -I ../.. -I ../../include -g -c '$$(CC) $$(CFLAGS) -DPIC -fPIC' $(STORAGE_MYSQL_CFILES) > deps.make

include deps.make

storage_mysql.so : $(STORAGE_MYSQL_OFILES)
