...
static struct field_description fields[USERLIST_NM_LAST] =
{
 ...
 [USERLIST_NN_LAST_PWDCHANGE_TIME]={"pwdtime",USERLIST_NN_LAST_PWDCHANGE_TIME},
  ...
  [USERLIST_NC_LAST_CHANGE_TIME] = { "changetime", USERLIST_NC_CREATE_TIME },
  [USERLIST_NC_LAST_PWDCHANGE_TIME] = { "pwdtime", USERLIST_NC_CREATE_TIME },
  ...
  [USERLIST_NM_LAST_CHANGE_TIME] = { "changetime", USERLIST_NM_CREATE_TIME },
