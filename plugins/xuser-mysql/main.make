...
XUSER_MYSQL_CFILES = xuser_mysql.c

CFILES = $(XUSER_MYSQL_CFILES)
HFILES =
...
deps.make : $(CFILES) $(HFILES)
	../../cdeps -v XUSER_MYSQL_OFILES -I ../.. -I ../../include -g -c '$$(CC) $$(CFLAGS) -DPIC -fPIC' $(XUSER_MYSQL_CFILES) > deps.make

include deps.make

xuser_mysql.so : $(XUSER_MYSQL_OFILES)
