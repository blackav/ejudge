...
AUTH_FB_CFILES = auth_fb.c

CFILES = $(AUTH_FB_CFILES)
HFILES =
...
deps.make : $(CFILES) $(HFILES)
	../../cdeps -v AUTH_FB_OFILES -I ../.. -I ../../include -g -c '$$(CC) $$(CFLAGS) -DPIC -fPIC' $(AUTH_FB_CFILES) > deps.make

include deps.make

auth_fb.so : $(AUTH_FB_OFILES)
