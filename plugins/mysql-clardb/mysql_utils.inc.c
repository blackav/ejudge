...
static int
db_error(struct cldb_mysql_state *state)
{
...
static void
db_wrong_field_count(struct cldb_mysql_state *state, int cnt)
{
...
static void
my_free_res(struct cldb_mysql_state *state)
{
...
static int
my_row(struct cldb_mysql_state *state)
{
  int i;
