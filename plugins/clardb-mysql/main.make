...
CLDB_MYSQL_CFILES = cldb_mysql.c

CFILES = $(CLDB_MYSQL_CFILES)
HFILES =
...
deps.make : $(CFILES) $(HFILES)
	../../cdeps -v CLDB_MYSQL_OFILES -I ../.. -I ../../include -g -c '$$(CC) $$(CFLAGS) -DPIC -fPIC' $(CLDB_MYSQL_CFILES) > deps.make
