const unsigned char * const ns_symbolic_action_table[NEW_SRV_ACTION_LAST] =
{
  ...
  [NEW_SRV_ACTION_LIST_PROBLEMS_JSON] = "list-problems-json",
  [NEW_SRV_ACTION_GET_PROBLEM_JSON] = "get-problem-json",
  [NEW_SRV_ACTION_REQUEST_REVIEW_JSON] = "request-review-json",
  [NEW_SRV_ACTION_LIST_REVIEWS_JSON] = "list-reviews-json",
  [NEW_SRV_ACTION_GET_REVIEW_JSON] = "get-review-json",
  [NEW_SRV_ACTION_UPDATE_REVIEW_JSON] = "update-review-json",
  [NEW_SRV_ACTION_PREMODERATE_JSON] = "premoderate-json",
  ...
  [NEW_SRV_ACTION_LIST_ACTIVE_REVIEWS_JSON] = "list-active-reviews-json",
  [NEW_SRV_ACTION_GET_ACTIVE_REVIEW_JSON] = "get-active-review-json",
