...
static int user_info_field_offsets[] =
{
  ...
  [USERLIST_NC_AVATAR_SUFFIX] = USER_INFO_OFFSET(avatar_suffix),
...
static int user_info_field_types[] =
{
  ...
  [USERLIST_NC_AVATAR_SUFFIX] = USERLIST_NC_INST,
...
} user_field_map[] =
{
  ...
  { "NC_AVATAR_SUFFIX", USERLIST_NC_AVATAR_SUFFIX },
...
static const unsigned char * const field_lookup_table[][7] =
{
  ...
  */
  ...
  [USERLIST_NC_AVATAR_SUFFIX] = { "avatar_suffix", NULL },
