        ...
        int auto_contest_id)
{
  ...
  unparse_texts(f, cnts, (const int[]) {
    CONTEST_REGISTER_EMAIL, CONTEST_REGISTER_URL, CONTEST_TEAM_URL, CONTEST_STANDINGS_URL,
    CONTEST_PROBLEMS_URL, CONTEST_ANALYTICS_URL, CONTEST_ANALYTICS_KEY, CONTEST_REGISTER_EMAIL_FILE,
    CONTEST_LOGIN_TEMPLATE, CONTEST_LOGIN_TEMPLATE_OPTIONS, CONTEST_LOGO_URL, CONTEST_CSS_URL,
    CONTEST_REGISTER_SUBJECT, CONTEST_REGISTER_SUBJECT_EN,
    0,
  });
