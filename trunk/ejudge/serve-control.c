...
static const int next_action_map[SSERV_CMD_LAST] =
{
  ...
  [SSERV_CMD_CNTS_BASIC_VIEW] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_ADVANCED_VIEW] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_HIDE_HTML_HEADERS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SHOW_HTML_HEADERS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_HIDE_HTML_ATTRS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SHOW_HTML_ATTRS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_HIDE_PATHS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SHOW_PATHS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_HIDE_NOTIFICATIONS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SHOW_NOTIFICATIONS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_HIDE_ACCESS_RULES] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SHOW_ACCESS_RULES] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_HIDE_PERMISSIONS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SHOW_PERMISSIONS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_HIDE_FORM_FIELDS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SHOW_FORM_FIELDS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_NAME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_NAME_EN] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_MAIN_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_KEYWORDS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USER_CONTEST] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_DEFAULT_LOCALE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_DEADLINE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_SCHED_TIME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_OPEN_TIME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_CLOSE_TIME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_HEADER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_FOOTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_HEADER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_FOOTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_HEADER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_MENU_1] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_MENU_2] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_MENU_3] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_SEPARATOR] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_FOOTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_PRIV_HEADER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_PRIV_FOOTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_COPYRIGHT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_WELCOME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REG_WELCOME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_HEAD_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_PAR_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_TABLE_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_VERB_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_TABLE_FORMAT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_TABLE_FORMAT_EN] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_TABLE_LEGEND] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_TABLE_LEGEND_EN] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_HEAD_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_PAR_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_TABLE_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_NAME_COMMENT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_ALLOWED_LANGUAGES] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_ALLOWED_REGIONS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_CF_NOTIFY_EMAIL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_CLAR_NOTIFY_EMAIL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_DAILY_STAT_EMAIL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_HEAD_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_PAR_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_EMAIL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_LOGIN_TEMPLATE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_LOGIN_TEMPLATE_OPTIONS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_EMAIL_FILE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_STANDINGS_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_PROBLEMS_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_LOGO_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_CSS_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_SUBJECT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_SUBJECT_EN] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_ROOT_DIR] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_CONF_DIR] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_HEADER_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_FOOTER_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_HEADER_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_FOOTER_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_HEADER_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_MENU_1_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_MENU_2_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_MENU_3_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_SEPARATOR_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_TEAM_FOOTER_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_PRIV_HEADER_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_PRIV_FOOTER_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_COPYRIGHT_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_WELCOME_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REG_WELCOME_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_EMAIL_FILE_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_NAME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_NAME_EN] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_MAIN_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_KEYWORDS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_USER_CONTEST] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_DEFAULT_LOCALE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_AUTOREGISTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_TEAM_PASSWD] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_SIMPLE_REGISTRATION] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_ASSIGN_LOGINS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_FORCE_REGISTRATION] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_DISABLE_NAME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_ENABLE_PASSWORD_RECOVERY] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_EXAM_MODE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_DISABLE_PASSWORD_CHANGE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_DISABLE_LOCALE_CHANGE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_PERSONAL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_ALLOW_REG_DATA_EDIT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_SEND_PASSWD_EMAIL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_MANAGED] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_RUN_MANAGED] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_OLD_RUN_MANAGED] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_CLEAN_USERS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_CLOSED] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_INVISIBLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_MEMBER_DELETE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_DEADLINE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_SCHED_TIME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_OPEN_TIME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_CLOSE_TIME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_USERS_HEADER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_USERS_FOOTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_REGISTER_HEADER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_REGISTER_FOOTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_TEAM_HEADER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_TEAM_MENU_1] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_TEAM_MENU_2] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_TEAM_MENU_3] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_TEAM_SEPARATOR] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_TEAM_FOOTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_PRIV_HEADER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_PRIV_FOOTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_COPYRIGHT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_WELCOME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_REG_WELCOME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_USERS_HEAD_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_USERS_PAR_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_USERS_TABLE_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_USERS_VERB_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_USERS_TABLE_FORMAT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_USERS_TABLE_FORMAT_EN] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_USERS_TABLE_LEGEND] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_USERS_TABLE_LEGEND_EN] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_REGISTER_HEAD_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_REGISTER_PAR_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_REGISTER_TABLE_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_REGISTER_NAME_COMMENT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_ALLOWED_LANGUAGES] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_ALLOWED_REGIONS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_CF_NOTIFY_EMAIL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_CLAR_NOTIFY_EMAIL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_DAILY_STAT_EMAIL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_TEAM_HEAD_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_TEAM_PAR_STYLE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_REGISTER_EMAIL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_REGISTER_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_LOGIN_TEMPLATE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_LOGIN_TEMPLATE_OPTIONS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_REGISTER_EMAIL_FILE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_TEAM_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_STANDINGS_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_PROBLEMS_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_LOGO_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_CSS_URL] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_REGISTER_SUBJECT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_REGISTER_SUBJECT_EN] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_ROOT_DIR] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_CONF_DIR] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_DIR_MODE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_DIR_GROUP] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_FILE_MODE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CHANGE_FILE_GROUP] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_DIR_MODE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_DIR_GROUP] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_FILE_MODE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_FILE_GROUP] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_DELETE_PERMISSION] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_ADD_PERMISSION] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_PERMISSIONS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SET_PREDEF_PERMISSIONS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_FORM_FIELDS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_CONTESTANT_FIELDS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_RESERVE_FIELDS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_COACH_FIELDS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_ADVISOR_FIELDS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_GUEST_FIELDS] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_USERS_HEADER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_USERS_FOOTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_REGISTER_HEADER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_REGISTER_FOOTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_TEAM_HEADER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_TEAM_MENU_1] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_TEAM_MENU_2] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_TEAM_MENU_3] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_TEAM_SEPARATOR] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_TEAM_FOOTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_PRIV_HEADER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_PRIV_FOOTER] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_COPYRIGHT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_WELCOME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_REG_WELCOME] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_SAVE_REGISTER_EMAIL_FILE] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_HEADER_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_USERS_FOOTER_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_HEADER_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_FOOTER_TEXT] = SSERV_CMD_NEW_CNTS_EDIT_CUR_CONTEST_PAGE,
  ...
  [SSERV_CMD_CNTS_CLEAR_TEAM_MENU_1_TEXT] = SSERV_CMD_CNTS_EDIT_TEAM_MENU_1,
  [SSERV_CMD_CNTS_CLEAR_TEAM_MENU_2_TEXT] = SSERV_CMD_CNTS_EDIT_TEAM_MENU_2,
  [SSERV_CMD_CNTS_CLEAR_TEAM_MENU_3_TEXT] = SSERV_CMD_CNTS_EDIT_TEAM_MENU_3,
  [SSERV_CMD_CNTS_CLEAR_TEAM_SEPARATOR_TEXT] = SSERV_CMD_CNTS_EDIT_TEAM_SEPARATOR,
  [SSERV_CMD_CNTS_CLEAR_TEAM_FOOTER_TEXT] = SSERV_CMD_CNTS_EDIT_TEAM_FOOTER,
  [SSERV_CMD_CNTS_CLEAR_PRIV_HEADER_TEXT] = SSERV_CMD_CNTS_EDIT_PRIV_HEADER,
  [SSERV_CMD_CNTS_CLEAR_PRIV_FOOTER_TEXT] = SSERV_CMD_CNTS_EDIT_PRIV_FOOTER,
  [SSERV_CMD_CNTS_CLEAR_COPYRIGHT_TEXT] = SSERV_CMD_CNTS_EDIT_COPYRIGHT,
  [SSERV_CMD_CNTS_CLEAR_WELCOME_TEXT] = SSERV_CMD_CNTS_EDIT_COPYRIGHT,
  [SSERV_CMD_CNTS_CLEAR_REG_WELCOME_TEXT] = SSERV_CMD_CNTS_EDIT_COPYRIGHT,
  ...
  [SSERV_CMD_GLOB_CHANGE_CHECKER_LOCALE] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CLEAR_CHECKER_LOCALE] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_PRINTOUT_USES_LOGIN] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_ADVANCED_LAYOUT] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_UUID_RUN_STORE] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_ENABLE_32BIT_CHECKERS] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_IGNORE_BOM] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_DISABLE_USER_DATABASE] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_ENABLE_MAX_STACK_SIZE] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_DISABLE_AUTO_REFRESH] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_DISABLE_LANGUAGE] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_PROBLEM_NAVIGATION] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_VERTICAL_NAVIGATION] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_DISABLE_VIRTUAL_START] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_DISABLE_VIRTUAL_AUTO_JUDGE] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_ENABLE_AUTO_PRINT_PROTOCOL] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_NOTIFY_CLAR_REPLY] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_NOTIFY_STATUS_CHANGE] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_PLUGIN_DIR] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CLEAR_PLUGIN_DIR] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_CONTEST_STOP_CMD] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CLEAR_CONTEST_STOP_CMD] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_STAND_FANCY_STYLE] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_STAND_USE_LOGIN] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_STAND_COLLATE_NAME] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_STAND_ENABLE_PENALTY] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_STAND_DISQ_ATTR] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CLEAR_STAND_DISQ_ATTR] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_USE_AC_NOT_OK] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_MEMOIZE_USER_RESULTS] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_ENABLE_WIN32_LANGUAGES] =SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_SECURE_RUN] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_DETECT_VIOLATIONS] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_ENABLE_MEMORY_LIMIT_ERROR] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_SEPARATE_USER_SCORE] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_LOAD_USER_GROUP] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CLEAR_LOAD_USER_GROUP] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_CLARDB_PLUGIN] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CLEAR_CLARDB_PLUGIN] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_RUNDB_PLUGIN] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CLEAR_RUNDB_PLUGIN] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_XUSER_PLUGIN] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CLEAR_XUSER_PLUGIN] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_CHANGE_STANDINGS_CHARSET] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CLEAR_STANDINGS_CHARSET] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_STAND2_CHARSET] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CLEAR_STAND2_CHARSET] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CHANGE_PLOG_CHARSET] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CLEAR_PLOG_CHARSET] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  ...
  [SSERV_CMD_GLOB_SAVE_CONTEST_STOP_CMD] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
  [SSERV_CMD_GLOB_CLEAR_CONTEST_STOP_CMD_TEXT] = SSERV_CMD_GLOB_EDIT_CONTEST_STOP_CMD,
  [SSERV_CMD_GLOB_CLEAR_CONTEST_STOP_CMD_TEXT] = SSERV_CMD_EDIT_CURRENT_GLOBAL,
