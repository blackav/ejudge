...
static const int action_to_cmd_map[SUPER_ACTION_LAST] =
{
  ...
  [SUPER_ACTION_CNTS_CLEAR_DAYLY_STAT_EMAIL] = SSERV_CMD_CNTS_CLEAR_DAYLY_STAT_EMAIL,
  ...
  [SUPER_ACTION_CNTS_CHANGE_DAYLY_STAT_EMAIL] = SSERV_CMD_CNTS_CHANGE_DAYLY_STAT_EMAIL,
...
static const int next_action_map[SUPER_ACTION_LAST] =
{
  ...
  [SUPER_ACTION_CNTS_CLEAR_DAYLY_STAT_EMAIL] = SUPER_ACTION_EDIT_CURRENT_CONTEST,
  ...
  [SUPER_ACTION_CNTS_CHANGE_DAYLY_STAT_EMAIL] = SUPER_ACTION_EDIT_CURRENT_CONTEST,
...
main(int argc, char *argv[])
{
  ...
  case SUPER_ACTION_CNTS_CHANGE_DAYLY_STAT_EMAIL:
  ...
  case SUPER_ACTION_CNTS_CLEAR_DAYLY_STAT_EMAIL:
