...
static const int next_action_map[SSERV_CMD_LAST] =
{
  ...
  [SSERV_CMD_CNTS_CLEAR_REGISTER_HEADER_TEXT] = 0,
  [SSERV_CMD_CNTS_CLEAR_REGISTER_FOOTER_TEXT] = 0,
  [SSERV_CMD_CNTS_CLEAR_TEAM_HEADER_TEXT] = 0,
  [SSERV_CMD_CNTS_CLEAR_TEAM_MENU_1_TEXT] = 0,
  [SSERV_CMD_CNTS_CLEAR_TEAM_MENU_2_TEXT] = 0,
  [SSERV_CMD_CNTS_CLEAR_TEAM_MENU_3_TEXT] = 0,
  [SSERV_CMD_CNTS_CLEAR_TEAM_SEPARATOR_TEXT] = 0,
  [SSERV_CMD_CNTS_CLEAR_TEAM_FOOTER_TEXT] = 0,
  [SSERV_CMD_CNTS_CLEAR_PRIV_HEADER_TEXT] = 0,
  [SSERV_CMD_CNTS_CLEAR_PRIV_FOOTER_TEXT] = 0,
  ...
  [SSERV_CMD_GLOB_CLEAR_CONTEST_START_CMD_TEXT] = 0,
  ...
  [SSERV_CMD_GLOB_CLEAR_CONTEST_STOP_CMD_TEXT] = 0,
