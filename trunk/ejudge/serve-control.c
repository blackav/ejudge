...
static const int action_to_cmd_map[SUPER_ACTION_LAST] =
{
  ...
  [SUPER_ACTION_PROB_CHANGE_OUTPUT_ONLY] = SSERV_CMD_PROB_CHANGE_OUTPUT_ONLY,
...
static const int next_action_map[SUPER_ACTION_LAST] =
{
  ...
  [SUPER_ACTION_PROB_CHANGE_OUTPUT_ONLY] = SUPER_ACTION_EDIT_CURRENT_PROB,
...
main(int argc, char *argv[])
{
  ...
  case SUPER_ACTION_PROB_CHANGE_OUTPUT_ONLY:
