...
static const int next_action_map[SSERV_CMD_LAST] =
{
  ...
  [SSERV_CMD_LANG_CHANGE_STYLE_CHECKER_ENV] = SSERV_CMD_EDIT_CURRENT_LANG,
  [SSERV_CMD_LANG_CLEAR_STYLE_CHECKER_ENV] = SSERV_CMD_EDIT_CURRENT_LANG,
  ...
  [SSERV_CMD_GLOB_CHANGE_COMPILE_MAX_VM_SIZE] = SSERV_CMD_EDIT_CURRENT_LANG,
  [SSERV_CMD_GLOB_CHANGE_COMPILE_MAX_STACK_SIZE] = SSERV_CMD_EDIT_CURRENT_LANG,
  [SSERV_CMD_GLOB_CHANGE_COMPILE_MAX_FILE_SIZE] = SSERV_CMD_EDIT_CURRENT_LANG,
};
...
main(int argc, char *argv[])
{
  ...
  case _SSERV_CMD_EDIT_CURRENT_GLOBAL:
