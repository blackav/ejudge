        ...
        struct http_request_info *phr)
{
  ...
  if (s) {
    ...
    if (errno || *eptr || (char*) s == eptr) FAIL(S_ERR_INV_PROB_ID);
    if (prob_id < 0 || prob_id > EJ_MAX_PROB_ID) FAIL(S_ERR_INV_PROB_ID);
  }

  if (super_html_add_problem(phr->ss, prob_id) < 0) FAIL(S_ERR_INV_PROB_ID);
...
static const int external_action_aliases[SSERV_CMD_LAST] =
{
  ...
  [SSERV_CMD_NEW_GLOB_EDIT_CONTEST_STOP_CMD_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  [SSERV_CMD_NEW_GLOB_EDIT_STAND_HEADER_FILE_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  [SSERV_CMD_NEW_GLOB_EDIT_STAND_FOOTER_FILE_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  [SSERV_CMD_NEW_GLOB_EDIT_STAND2_HEADER_FILE_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  [SSERV_CMD_NEW_GLOB_EDIT_STAND2_FOOTER_FILE_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  [SSERV_CMD_NEW_GLOB_EDIT_PLOG_HEADER_FILE_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  [SSERV_CMD_NEW_GLOB_EDIT_PLOG_FOOTER_FILE_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  [SSERV_CMD_NEW_CNTS_EDIT_USERS_HEADER_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  [SSERV_CMD_NEW_CNTS_EDIT_USERS_FOOTER_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  [SSERV_CMD_NEW_CNTS_EDIT_COPYRIGHT_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  [SSERV_CMD_NEW_CNTS_EDIT_WELCOME_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  [SSERV_CMD_NEW_CNTS_EDIT_REG_WELCOME_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  [SSERV_CMD_NEW_CNTS_EDIT_REGISTER_EMAIL_FILE_PAGE] = SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
};
static const unsigned char * const external_action_names[SSERV_CMD_LAST] =
{
  ...
  [SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE] = "cnts_edit_file_page",
};
