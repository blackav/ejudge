...
enum
{
  ...
  SSERV_CMD_CHECK_TESTS, // UNUSED
  _SSERV_CMD_CNTS_EDIT_PERMISSION,
...
/* subcommands for SSERV_CMD_HTTP_REQUEST */
  ...
  SSERV_CMD_NEW_MAIN_PAGE,
  SSERV_CMD_NEW_CONTEST_PAGE,
  SSERV_CMD_NEW_CONTEST_XML_PAGE,
  SSERV_CMD_NEW_SERVE_CFG_PAGE,
  SSERV_CMD_NEW_CREATE_CONTEST_PAGE,
  SSERV_CMD_CONTEST_ALREADY_EDITED_PAGE,
  SSERV_CMD_NEW_CHECK_TESTS_PAGE,
  SSERV_CMD_NEW_EDIT_PERMISSIONS_PAGE,
