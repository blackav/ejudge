...
/* subcommands for SSERV_CMD_HTTP_REQUEST */
  ...
  SSERV_CMD_NEW_GLOB_EDIT_CONTEST_START_CMD_PAGE,
  SSERV_CMD_NEW_GLOB_EDIT_CONTEST_STOP_CMD_PAGE,
  SSERV_CMD_NEW_GLOB_EDIT_STAND_HEADER_FILE_PAGE,
  SSERV_CMD_NEW_GLOB_EDIT_STAND_FOOTER_FILE_PAGE,
  SSERV_CMD_NEW_GLOB_EDIT_STAND2_HEADER_FILE_PAGE,
  SSERV_CMD_NEW_GLOB_EDIT_STAND2_FOOTER_FILE_PAGE,
  SSERV_CMD_NEW_GLOB_EDIT_PLOG_HEADER_FILE_PAGE,
  SSERV_CMD_NEW_GLOB_EDIT_PLOG_FOOTER_FILE_PAGE,
  SSERV_CMD_NEW_CNTS_EDIT_USERS_HEADER_PAGE,
  SSERV_CMD_NEW_CNTS_EDIT_USERS_FOOTER_PAGE,
  SSERV_CMD_NEW_CNTS_EDIT_COPYRIGHT_PAGE,
  SSERV_CMD_NEW_CNTS_EDIT_WELCOME_PAGE,
  SSERV_CMD_NEW_CNTS_EDIT_REG_WELCOME_PAGE,
  SSERV_CMD_NEW_CNTS_EDIT_REGISTER_EMAIL_FILE_PAGE,
