...
enum
{
  ...
  SSERV_OP_USER_FILTER_CHANGE_ACTION,
  ...
  SSERV_OP_USER_CREATE_ONE_PAGE,
  SSERV_OP_USER_CREATE_ONE_ACTION,
  SSERV_OP_USER_CREATE_MANY_PAGE,
  SSERV_OP_USER_CREATE_MANY_ACTION,
  SSERV_OP_USER_CREATE_FROM_CSV_PAGE,
  SSERV_OP_USER_CREATE_FROM_CSV_ACTION,
  SSERV_OP_USER_DETAIL_PAGE,
  SSERV_OP_USER_PASSWORD_PAGE,
  SSERV_OP_USER_CHANGE_PASSWORD_ACTION,
  SSERV_OP_USER_CNTS_PASSWORD_PAGE,
  SSERV_OP_USER_CHANGE_CNTS_PASSWORD_ACTION,
