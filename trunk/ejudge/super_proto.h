...
enum
{
  ...
  SSERV_OP_USER_SEL_ADD_TO_GROUP_PAGE,
  SSERV_OP_USER_SEL_ADD_TO_GROUP_ACTION,
  SSERV_OP_USER_SEL_REMOVE_FROM_GROUP_PAGE,
  SSERV_OP_USER_SEL_REMOVE_FROM_GROUP_ACTION,
