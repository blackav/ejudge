...
static const unsigned char csp_str8[35] = "</h1>\n\n<h2>Registered users</h2>\n\n";
static const unsigned char csp_str9[297] = "\n<table class=\"b1\"><tr><th class=\"b1\">NN</th><th class=\"b1\">Id</th><th class=\"b1\">Login</th><th class=\"b1\">Name</th><th class=\"b1\">Status</th><th class=\"b1\">Flags</th><th class=\"b1\">Reg. date</th><th class=\"b1\">Login date</th><th class=\"b1\">No. of submits</th><th class=\"b1\">Size of submits</th>\n";
static const unsigned char csp_str10[28] = "\n<th class=\"b1\">Score</th>\n";
static const unsigned char csp_str11[34] = "\n<th class=\"b1\">Select</th></tr>\n";
static const unsigned char csp_str12[5] = "\n<tr";
static const unsigned char csp_str13[18] = ">\n<td class=\"b1\">";
static const unsigned char csp_str14[7] = "</td>\n";
static const unsigned char csp_str15[2] = "\n";
static const unsigned char csp_str16[6] = "\n    ";
static const unsigned char csp_str17[17] = "\n<td class=\"b1\">";
static const unsigned char csp_str18[8] = "</td>\n\n";
static const unsigned char csp_str19[29] = "\n<td class=\"b1\">&nbsp;</td>\n";
static const unsigned char csp_str20[21] = "</td><td class=\"b1\">";
static const unsigned char csp_str21[55] = "\n<td class=\"b1\">&nbsp;</td><td class=\"b1\">&nbsp;</td>\n";
static const unsigned char csp_str22[51] = "\n<td class=\"b1\"><input type=\"checkbox\" name=\'user_";
static const unsigned char csp_str23[16] = "\'/></td>\n</tr>\n";
static const unsigned char csp_str24[50] = "\n</table>\n\n<h2>Users range</h2>\n\n<table>\n<tr><td>";
static const unsigned char csp_str25[82] = ":</td><td><input type=\"text\" name=\"first_user_id\" size=\"16\" /></td></tr>\n<tr><td>";
static const unsigned char csp_str26[126] = "</td><td><input type=\"text\" name=\"last_user_id\" size=\"16\" /></td></tr>\n</table>\n\n<h2>Available actions</h2>\n\n<table>\n<tr><td>";
static const unsigned char csp_str27[10] = "</td><td>";
static const unsigned char csp_str28[20] = "</td></tr>\n<tr><td>";
static const unsigned char csp_str29[12] = "</td></tr>\n";
static const unsigned char csp_str30[10] = "\n<tr><td>";
static const unsigned char csp_str31[3] = "\n\n";
static const unsigned char csp_str32[16] = "\n</table>\n\n<h2>";
static const unsigned char csp_str33[10] = "</h2>\n<p>";
static const unsigned char csp_str34[115] = ":<br>\n<p><textarea name=\"disq_comment\" rows=\"5\" cols=\"60\">\n</textarea></p>\n\n<table class=\"b0\"><tr>\n<td class=\"b0\">";
static const unsigned char csp_str35[26] = "</td>\n</tr></table>\n\n<h2>";
static const unsigned char csp_str36[79] = "</h2>\n<table>\n<tr><td><input type=\"text\" size=\"32\" name=\"add_login\"/></td><td>";
static const unsigned char csp_str37[78] = "</td></tr>\n<tr><td><input type=\"text\" size=\"32\" name=\"add_user_id\"/></td><td>";
static const unsigned char csp_str38[21] = "</td></tr>\n</table>\n";
static const unsigned char csp_str39[9] = "\n\n<hr/>\n";
...
#line 29 "priv_view_users_page.csp"
...
fwrite(csp_str9, 1, 296, out_f);

#line 97 "priv_view_users_page.csp"
if (global->memoize_user_results > 0) {
fwrite(csp_str10, 1, 27, out_f);

#line 99 "priv_view_users_page.csp"
}
fwrite(csp_str11, 1, 33, out_f);

#line 101 "priv_view_users_page.csp"
...
fwrite(csp_str12, 1, 4, out_f);
fputs((form_row_attrs[row ^= 1]), out_f);
fwrite(csp_str13, 1, 17, out_f);
fprintf(out_f, "%d", (int)(serial++));
fwrite(csp_str14, 1, 6, out_f);

#line 108 "priv_view_users_page.csp"
...
#line 117 "priv_view_users_page.csp"
} else {
fwrite(csp_str17, 1, 16, out_f);
fputs(html_armor_buf(&ab, (u->login)), out_f);
fwrite(csp_str14, 1, 6, out_f);

#line 119 "priv_view_users_page.csp"
}
fwrite(csp_str15, 1, 1, out_f);

#line 120 "priv_view_users_page.csp"
...
fwrite(csp_str19, 1, 28, out_f);

#line 124 "priv_view_users_page.csp"
}
fwrite(csp_str17, 1, 16, out_f);
fputs((userlist_unparse_reg_status(uc->status)), out_f);
fwrite(csp_str14, 1, 6, out_f);

#line 126 "priv_view_users_page.csp"
...
#line 142 "priv_view_users_page.csp"
}
fwrite(csp_str15, 1, 1, out_f);
...
#line 145 "priv_view_users_page.csp"
} else {
fwrite(csp_str19, 1, 28, out_f);

#line 147 "priv_view_users_page.csp"
}
fwrite(csp_str15, 1, 1, out_f);

#line 148 "priv_view_users_page.csp"
if (u->cnts0 && u->cnts0->last_login_time > 0) {
fwrite(csp_str17, 1, 16, out_f);
fputs(xml_unparse_date((u->cnts0->last_login_time)), out_f);
fwrite(csp_str14, 1, 6, out_f);

#line 150 "priv_view_users_page.csp"
} else {
fwrite(csp_str19, 1, 28, out_f);

#line 152 "priv_view_users_page.csp"
}
fwrite(csp_str15, 1, 1, out_f);

#line 153 "priv_view_users_page.csp"
if (run_counts[uid] > 0) {
fwrite(csp_str17, 1, 16, out_f);
...
#line 155 "priv_view_users_page.csp"
} else {
fwrite(csp_str21, 1, 54, out_f);

#line 157 "priv_view_users_page.csp"
}
fwrite(csp_str15, 1, 1, out_f);

#line 158 "priv_view_users_page.csp"
if (global->memoize_user_results > 0) {
fwrite(csp_str17, 1, 16, out_f);
fprintf(out_f, "%d", (int)(serve_get_user_result_score(extra->serve_state, uid)));
fwrite(csp_str14, 1, 6, out_f);

#line 160 "priv_view_users_page.csp"
}
fwrite(csp_str22, 1, 50, out_f);
fprintf(out_f, "%d", (int)(uid));
fwrite(csp_str23, 1, 15, out_f);

#line 163 "priv_view_users_page.csp"
}
fwrite(csp_str24, 1, 49, out_f);
fputs(_("First User_Id"), out_f);
fwrite(csp_str25, 1, 81, out_f);
fputs(_("Last User_Id (incl.)"), out_f);
fwrite(csp_str26, 1, 125, out_f);
fputs(ns_aref(hbuf, sizeof(hbuf), phr, NEW_SRV_ACTION_MAIN_PAGE, 0), out_f);
fputs(_("Back"), out_f);
fputs("</a>", out_f);
fwrite(csp_str27, 1, 9, out_f);
fputs(_("Return to the main page"), out_f);
fwrite(csp_str28, 1, 19, out_f);
...
fwrite(csp_str29, 1, 11, out_f);

#line 190 "priv_view_users_page.csp"
if (global->is_virtual) {
fwrite(csp_str30, 1, 9, out_f);
...
#line 192 "priv_view_users_page.csp"
}
fwrite(csp_str31, 1, 2, out_f);

#line 194 "priv_view_users_page.csp"
...
#line 196 "priv_view_users_page.csp"
}
fwrite(csp_str15, 1, 1, out_f);

#line 197 "priv_view_users_page.csp"
...
#line 199 "priv_view_users_page.csp"
}
fwrite(csp_str15, 1, 1, out_f);

#line 200 "priv_view_users_page.csp"
if (global->full_exam_protocol_header_txt) {
fwrite(csp_str30, 1, 9, out_f);
...
fwrite(csp_str38, 1, 20, out_f);
fputs("</form>", out_f);
fwrite(csp_str39, 1, 8, out_f);
write_copyright_short(out_f);
fwrite(csp_str40, 1, 17, out_f);

#line 226 "priv_view_users_page.csp"
l10n_setlocale(0);
