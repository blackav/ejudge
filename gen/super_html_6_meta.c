...
static struct meta_info_item meta_info_ss_op_param_USER_CREATE_ONE_ACTION_data[] =
{
  ...
  [META_SS_OP_PARAM_USER_CREATE_ONE_ACTION_is_privileged] = { META_SS_OP_PARAM_USER_CREATE_ONE_ACTION_is_privileged, '3', XSIZE(struct ss_op_param_USER_CREATE_ONE_ACTION, is_privileged), "is_privileged", XOFFSET(struct ss_op_param_USER_CREATE_ONE_ACTION, is_privileged) },
  [META_SS_OP_PARAM_USER_CREATE_ONE_ACTION_is_reg_readonly] = { META_SS_OP_PARAM_USER_CREATE_ONE_ACTION_is_reg_readonly, '3', XSIZE(struct ss_op_param_USER_CREATE_ONE_ACTION, is_reg_readonly), "is_reg_readonly", XOFFSET(struct ss_op_param_USER_CREATE_ONE_ACTION, is_reg_readonly) },
...
void meta_ss_op_param_USER_CREATE_ONE_ACTION_copy(struct ss_op_param_USER_CREATE_ONE_ACTION *dst, const struct ss_op_param_USER_CREATE_ONE_ACTION *src)
{
  ...
  if (src->other_login) {
    dst->other_login = strdup(src->other_login);
  }
  if (src->other_email) {
    dst->other_email = strdup(src->other_email);
  }
  dst->send_email = src->send_email;
  dst->confirm_email = src->confirm_email;
  if (src->reg_password1) {
    dst->reg_password1 = strdup(src->reg_password1);
  }
  if (src->reg_password2) {
    dst->reg_password2 = strdup(src->reg_password2);
  }
  dst->reg_sha1 = src->reg_sha1;
  dst->field_1 = src->field_1;
  dst->field_2 = src->field_2;
  dst->field_3 = src->field_3;
  dst->field_4 = src->field_4;
  dst->field_5 = src->field_5;
  dst->field_6 = src->field_6;
  dst->field_7 = src->field_7;
  dst->field_8 = src->field_8;
  dst->field_9 = src->field_9;
  dst->reg_cnts_create = src->reg_cnts_create;
  dst->other_contest_id_1 = src->other_contest_id_1;
  dst->cnts_status = src->cnts_status;
  dst->is_invisible = src->is_invisible;
  dst->is_banned = src->is_banned;
  dst->is_locked = src->is_locked;
  dst->is_incomplete = src->is_incomplete;
  dst->is_disqualified = src->is_disqualified;
  dst->is_privileged = src->is_privileged;
  dst->is_reg_readonly = src->is_reg_readonly;
  dst->cnts_use_reg_passwd = src->cnts_use_reg_passwd;
  dst->cnts_null_passwd = src->cnts_null_passwd;
  if (src->cnts_password1) {
    dst->cnts_password1 = strdup(src->cnts_password1);
  }
  if (src->cnts_password2) {
    dst->cnts_password2 = strdup(src->cnts_password2);
  }
  dst->cnts_sha1 = src->cnts_sha1;
  if (src->cnts_name) {
    dst->cnts_name = strdup(src->cnts_name);
  }
  dst->group_create = src->group_create;
  dst->other_group_id = src->other_group_id;
}

void meta_ss_op_param_USER_CREATE_ONE_ACTION_free(struct ss_op_param_USER_CREATE_ONE_ACTION *ptr)
{
  free(ptr->other_login);
  free(ptr->other_email);
  free(ptr->reg_password1);
  free(ptr->reg_password2);
  free(ptr->cnts_password1);
  free(ptr->cnts_password2);
  free(ptr->cnts_name);
}
...
static struct meta_info_item meta_info_ss_op_param_USER_CREATE_MANY_ACTION_data[] =
{
  ...
  [META_SS_OP_PARAM_USER_CREATE_MANY_ACTION_is_privileged] = { META_SS_OP_PARAM_USER_CREATE_MANY_ACTION_is_privileged, '3', XSIZE(struct ss_op_param_USER_CREATE_MANY_ACTION, is_privileged), "is_privileged", XOFFSET(struct ss_op_param_USER_CREATE_MANY_ACTION, is_privileged) },
  [META_SS_OP_PARAM_USER_CREATE_MANY_ACTION_is_reg_readonly] = { META_SS_OP_PARAM_USER_CREATE_MANY_ACTION_is_reg_readonly, '3', XSIZE(struct ss_op_param_USER_CREATE_MANY_ACTION, is_reg_readonly), "is_reg_readonly", XOFFSET(struct ss_op_param_USER_CREATE_MANY_ACTION, is_reg_readonly) },
...
void meta_ss_op_param_USER_CREATE_MANY_ACTION_copy(struct ss_op_param_USER_CREATE_MANY_ACTION *dst, const struct ss_op_param_USER_CREATE_MANY_ACTION *src)
{
  dst->contest_id = src->contest_id;
  dst->group_id = src->group_id;
  dst->first_serial = src->first_serial;
  dst->last_serial = src->last_serial;
  if (src->login_template) {
    dst->login_template = strdup(src->login_template);
  }
  dst->reg_random = src->reg_random;
  if (src->reg_password_template) {
    dst->reg_password_template = strdup(src->reg_password_template);
  }
  dst->reg_sha1 = src->reg_sha1;
  dst->field_1 = src->field_1;
  dst->field_2 = src->field_2;
  ...
  dst->cnts_use_reg_passwd = src->cnts_use_reg_passwd;
  dst->cnts_null_passwd = src->cnts_null_passwd;
  dst->cnts_random_passwd = src->cnts_random_passwd;
  if (src->cnts_password_template) {
    dst->cnts_password_template = strdup(src->cnts_password_template);
  }
  dst->cnts_sha1 = src->cnts_sha1;
  if (src->cnts_name_template) {
    dst->cnts_name_template = strdup(src->cnts_name_template);
  }
  dst->group_create = src->group_create;
  dst->other_group_id = src->other_group_id;
}
...
void meta_ss_op_param_USER_CREATE_MANY_ACTION_free(struct ss_op_param_USER_CREATE_MANY_ACTION *ptr)
{
  ...
  free(ptr->reg_password_template);
  free(ptr->cnts_password_template);
  free(ptr->cnts_name_template);
}
...
static struct meta_info_item meta_info_ss_op_param_USER_CREATE_FROM_CSV_ACTION_data[] =
{
  ...
  [META_SS_OP_PARAM_USER_CREATE_FROM_CSV_ACTION_is_privileged] = { META_SS_OP_PARAM_USER_CREATE_FROM_CSV_ACTION_is_privileged, '3', XSIZE(struct ss_op_param_USER_CREATE_FROM_CSV_ACTION, is_privileged), "is_privileged", XOFFSET(struct ss_op_param_USER_CREATE_FROM_CSV_ACTION, is_privileged) },
  [META_SS_OP_PARAM_USER_CREATE_FROM_CSV_ACTION_is_reg_readonly] = { META_SS_OP_PARAM_USER_CREATE_FROM_CSV_ACTION_is_reg_readonly, '3', XSIZE(struct ss_op_param_USER_CREATE_FROM_CSV_ACTION, is_reg_readonly), "is_reg_readonly", XOFFSET(struct ss_op_param_USER_CREATE_FROM_CSV_ACTION, is_reg_readonly) },
  ...
  [META_SS_OP_PARAM_USER_CREATE_FROM_CSV_ACTION_reset_existing_passwords] = { META_SS_OP_PARAM_USER_CREATE_FROM_CSV_ACTION_reset_existing_passwords, '3', XSIZE(struct ss_op_param_USER_CREATE_FROM_CSV_ACTION, reset_existing_passwords), "reset_existing_passwords", XOFFSET(struct ss_op_param_USER_CREATE_FROM_CSV_ACTION, reset_existing_passwords) },
};
...
void meta_ss_op_param_USER_CREATE_FROM_CSV_ACTION_copy(struct ss_op_param_USER_CREATE_FROM_CSV_ACTION *dst, const struct ss_op_param_USER_CREATE_FROM_CSV_ACTION *src)
{
  ...
  dst->other_group_id = src->other_group_id;
  if (src->separator) {
    dst->separator = strdup(src->separator);
  }
  if (src->charset) {
    dst->charset = strdup(src->charset);
  }
  dst->register_existing = src->register_existing;
  dst->reset_existing_passwords = src->reset_existing_passwords;
}
...
static struct meta_info_item meta_info_ss_op_param_USER_CREATE_REG_ACTION_data[] =
{
  ...
  [META_SS_OP_PARAM_USER_CREATE_REG_ACTION_is_privileged] = { META_SS_OP_PARAM_USER_CREATE_REG_ACTION_is_privileged, '3', XSIZE(struct ss_op_param_USER_CREATE_REG_ACTION, is_privileged), "is_privileged", XOFFSET(struct ss_op_param_USER_CREATE_REG_ACTION, is_privileged) },
  [META_SS_OP_PARAM_USER_CREATE_REG_ACTION_is_reg_readonly] = { META_SS_OP_PARAM_USER_CREATE_REG_ACTION_is_reg_readonly, '3', XSIZE(struct ss_op_param_USER_CREATE_REG_ACTION, is_reg_readonly), "is_reg_readonly", XOFFSET(struct ss_op_param_USER_CREATE_REG_ACTION, is_reg_readonly) },
};
...
{
  dst->other_user_id = src->other_user_id;
  dst->contest_id = src->contest_id;
  dst->group_id = src->group_id;
  dst->other_contest_id_1 = src->other_contest_id_1;
...
static struct meta_info_item meta_info_ss_op_param_USER_EDIT_REG_ACTION_data[] =
{
  ...
  [META_SS_OP_PARAM_USER_EDIT_REG_ACTION_is_privileged] = { META_SS_OP_PARAM_USER_EDIT_REG_ACTION_is_privileged, '3', XSIZE(struct ss_op_param_USER_EDIT_REG_ACTION, is_privileged), "is_privileged", XOFFSET(struct ss_op_param_USER_EDIT_REG_ACTION, is_privileged) },
  [META_SS_OP_PARAM_USER_EDIT_REG_ACTION_is_reg_readonly] = { META_SS_OP_PARAM_USER_EDIT_REG_ACTION_is_reg_readonly, '3', XSIZE(struct ss_op_param_USER_EDIT_REG_ACTION, is_reg_readonly), "is_reg_readonly", XOFFSET(struct ss_op_param_USER_EDIT_REG_ACTION, is_reg_readonly) },
};
...
{
  dst->other_user_id = src->other_user_id;
  dst->other_contest_id = src->other_contest_id;
  dst->contest_id = src->contest_id;
  dst->group_id = src->group_id;
  dst->next_op = src->next_op;
  dst->status = src->status;
  dst->is_invisible = src->is_invisible;
  dst->is_banned = src->is_banned;
  dst->is_locked = src->is_locked;
