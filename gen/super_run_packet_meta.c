...
static struct meta_info_item meta_info_super_run_in_global_packet_data[] =
{
  ...
  [META_SUPER_RUN_IN_GLOBAL_PACKET_has_extended_status] = { META_SUPER_RUN_IN_GLOBAL_PACKET_has_extended_status, 'B', XSIZE(struct super_run_in_global_packet, has_extended_status), "has_extended_status", XOFFSET(struct super_run_in_global_packet, has_extended_status) },
};
...
void meta_super_run_in_global_packet_copy(struct super_run_in_global_packet *dst, const struct super_run_in_global_packet *src)
{
  ...
  dst->has_extended_status = src->has_extended_status;
