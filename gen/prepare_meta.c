...
static struct meta_info_item meta_info_section_problem_data_data[] =
{
  ...
  [CNTSPROB_enable_group_merge] = { CNTSPROB_enable_group_merge, 'f', XSIZE(struct section_problem_data, enable_group_merge), "enable_group_merge", XOFFSET(struct section_problem_data, enable_group_merge) },
  [CNTSPROB_ignore_sigpipe] = { CNTSPROB_ignore_sigpipe, 'f', XSIZE(struct section_problem_data, ignore_sigpipe), "ignore_sigpipe", XOFFSET(struct section_problem_data, ignore_sigpipe) },
  [CNTSPROB_enable_external_review] = { CNTSPROB_enable_external_review, 'f', XSIZE(struct section_problem_data, enable_external_review), "enable_external_review", XOFFSET(struct section_problem_data, enable_external_review) },
  [CNTSPROB_enable_user_review_request] = { CNTSPROB_enable_user_review_request, 'f', XSIZE(struct section_problem_data, enable_user_review_request), "enable_user_review_request", XOFFSET(struct section_problem_data, enable_user_review_request) },
  [CNTSPROB_enable_user_help_request] = { CNTSPROB_enable_user_help_request, 'f', XSIZE(struct section_problem_data, enable_user_help_request), "enable_user_help_request", XOFFSET(struct section_problem_data, enable_user_help_request) },
  [CNTSPROB_disable_pre_moderation] = { CNTSPROB_disable_pre_moderation, 'f', XSIZE(struct section_problem_data, disable_pre_moderation), "disable_pre_moderation", XOFFSET(struct section_problem_data, disable_pre_moderation) },
  [CNTSPROB_disable_post_approve] = { CNTSPROB_disable_post_approve, 'f', XSIZE(struct section_problem_data, disable_post_approve), "disable_post_approve", XOFFSET(struct section_problem_data, disable_post_approve) },
...
void cntsprob_copy(struct section_problem_data *dst, const struct section_problem_data *src)
{
  ...
  dst->enable_external_review = src->enable_external_review;
  dst->enable_user_review_request = src->enable_user_review_request;
  dst->enable_user_help_request = src->enable_user_help_request;
  dst->disable_pre_moderation = src->disable_pre_moderation;
  dst->disable_post_approve = src->disable_post_approve;
