...
static struct meta_info_item meta_info_polygon_packet_data[] =
{
  ...
  [META_POLYGON_PACKET_packet_file] = { META_POLYGON_PACKET_packet_file, 's', XSIZE(struct polygon_packet, packet_file), "packet_file", XOFFSET(struct polygon_packet, packet_file) },
