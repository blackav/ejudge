...
static struct meta_info_item meta_info_problem_config_section_data[] =
{
  ...
  [META_PROBLEM_CONFIG_SECTION_checker_time_limit] = { META_PROBLEM_CONFIG_SECTION_checker_time_limit, 'i', XSIZE(struct problem_config_section, checker_time_limit), "checker_time_limit", XOFFSET(struct problem_config_section, checker_time_limit) },
