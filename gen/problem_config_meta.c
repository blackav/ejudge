...
static struct meta_info_item meta_info_problem_config_section_data[] =
{
  ...
  [META_PROBLEM_CONFIG_SECTION_enable_checker_token] = { META_PROBLEM_CONFIG_SECTION_enable_checker_token, 'B', XSIZE(struct problem_config_section, enable_checker_token), "enable_checker_token", XOFFSET(struct problem_config_section, enable_checker_token) },
  ...
  [META_PROBLEM_CONFIG_SECTION_wtl_is_cf] = { META_PROBLEM_CONFIG_SECTION_wtl_is_cf, 'B', XSIZE(struct problem_config_section, wtl_is_cf), "wtl_is_cf", XOFFSET(struct problem_config_section, wtl_is_cf) },
  ...
  [META_PROBLEM_CONFIG_SECTION_score_tokenized] = { META_PROBLEM_CONFIG_SECTION_score_tokenized, 'B', XSIZE(struct problem_config_section, score_tokenized), "score_tokenized", XOFFSET(struct problem_config_section, score_tokenized) },
  ...
  [META_PROBLEM_CONFIG_SECTION_unrestricted_statement] = { META_PROBLEM_CONFIG_SECTION_unrestricted_statement, 'B', XSIZE(struct problem_config_section, unrestricted_statement), "unrestricted_statement", XOFFSET(struct problem_config_section, unrestricted_statement) },
  [META_PROBLEM_CONFIG_SECTION_statement_ignore_ip] = { META_PROBLEM_CONFIG_SECTION_statement_ignore_ip, 'B', XSIZE(struct problem_config_section, statement_ignore_ip), "statement_ignore_ip", XOFFSET(struct problem_config_section, statement_ignore_ip) },
  [META_PROBLEM_CONFIG_SECTION_enable_submit_after_reject] = { META_PROBLEM_CONFIG_SECTION_enable_submit_after_reject, 'B', XSIZE(struct problem_config_section, enable_submit_after_reject), "enable_submit_after_reject", XOFFSET(struct problem_config_section, enable_submit_after_reject) },
  [META_PROBLEM_CONFIG_SECTION_hide_file_names] = { META_PROBLEM_CONFIG_SECTION_hide_file_names, 'B', XSIZE(struct problem_config_section, hide_file_names), "hide_file_names", XOFFSET(struct problem_config_section, hide_file_names) },
  [META_PROBLEM_CONFIG_SECTION_hide_real_time_limit] = { META_PROBLEM_CONFIG_SECTION_hide_real_time_limit, 'B', XSIZE(struct problem_config_section, hide_real_time_limit), "hide_real_time_limit", XOFFSET(struct problem_config_section, hide_real_time_limit) },
  [META_PROBLEM_CONFIG_SECTION_enable_tokens] = { META_PROBLEM_CONFIG_SECTION_enable_tokens, 'B', XSIZE(struct problem_config_section, enable_tokens), "enable_tokens", XOFFSET(struct problem_config_section, enable_tokens) },
  [META_PROBLEM_CONFIG_SECTION_tokens_for_user_ac] = { META_PROBLEM_CONFIG_SECTION_tokens_for_user_ac, 'B', XSIZE(struct problem_config_section, tokens_for_user_ac), "tokens_for_user_ac", XOFFSET(struct problem_config_section, tokens_for_user_ac) },
  ...
  [META_PROBLEM_CONFIG_SECTION_enable_suid_run] = { META_PROBLEM_CONFIG_SECTION_enable_suid_run, 'B', XSIZE(struct problem_config_section, enable_suid_run), "enable_suid_run", XOFFSET(struct problem_config_section, enable_suid_run) },
  [META_PROBLEM_CONFIG_SECTION_enable_container] = { META_PROBLEM_CONFIG_SECTION_enable_container, 'B', XSIZE(struct problem_config_section, enable_container), "enable_container", XOFFSET(struct problem_config_section, enable_container) },
  [META_PROBLEM_CONFIG_SECTION_enable_multi_header] = { META_PROBLEM_CONFIG_SECTION_enable_multi_header, 'B', XSIZE(struct problem_config_section, enable_multi_header), "enable_multi_header", XOFFSET(struct problem_config_section, enable_multi_header) },
  [META_PROBLEM_CONFIG_SECTION_use_lang_multi_header] = { META_PROBLEM_CONFIG_SECTION_use_lang_multi_header, 'B', XSIZE(struct problem_config_section, use_lang_multi_header), "use_lang_multi_header", XOFFSET(struct problem_config_section, use_lang_multi_header) },
  [META_PROBLEM_CONFIG_SECTION_require_any] = { META_PROBLEM_CONFIG_SECTION_require_any, 'B', XSIZE(struct problem_config_section, require_any), "require_any", XOFFSET(struct problem_config_section, require_any) },
  ...
  [META_PROBLEM_CONFIG_SECTION_enable_kill_all] = { META_PROBLEM_CONFIG_SECTION_enable_kill_all, 'B', XSIZE(struct problem_config_section, enable_kill_all), "enable_kill_all", XOFFSET(struct problem_config_section, enable_kill_all) },
  [META_PROBLEM_CONFIG_SECTION_enable_testlib_mode] = { META_PROBLEM_CONFIG_SECTION_enable_testlib_mode, 'B', XSIZE(struct problem_config_section, enable_testlib_mode), "enable_testlib_mode", XOFFSET(struct problem_config_section, enable_testlib_mode) },
  [META_PROBLEM_CONFIG_SECTION_hide_variant] = { META_PROBLEM_CONFIG_SECTION_hide_variant, 'B', XSIZE(struct problem_config_section, hide_variant), "hide_variant", XOFFSET(struct problem_config_section, hide_variant) },
  [META_PROBLEM_CONFIG_SECTION_enable_extended_info] = { META_PROBLEM_CONFIG_SECTION_enable_extended_info, 'B', XSIZE(struct problem_config_section, enable_extended_info), "enable_extended_info", XOFFSET(struct problem_config_section, enable_extended_info) },
  [META_PROBLEM_CONFIG_SECTION_stop_on_first_fail] = { META_PROBLEM_CONFIG_SECTION_stop_on_first_fail, 'B', XSIZE(struct problem_config_section, stop_on_first_fail), "stop_on_first_fail", XOFFSET(struct problem_config_section, stop_on_first_fail) },
  [META_PROBLEM_CONFIG_SECTION_enable_control_socket] = { META_PROBLEM_CONFIG_SECTION_enable_control_socket, 'B', XSIZE(struct problem_config_section, enable_control_socket), "enable_control_socket", XOFFSET(struct problem_config_section, enable_control_socket) },
  ...
  [META_PROBLEM_CONFIG_SECTION_max_rss_size] = { META_PROBLEM_CONFIG_SECTION_max_rss_size, 'Z', XSIZE(struct problem_config_section, max_rss_size), "max_rss_size", XOFFSET(struct problem_config_section, max_rss_size) },
  ...
  [META_PROBLEM_CONFIG_SECTION_checker_max_vm_size] = { META_PROBLEM_CONFIG_SECTION_checker_max_vm_size, 'Z', XSIZE(struct problem_config_section, checker_max_vm_size), "checker_max_vm_size", XOFFSET(struct problem_config_section, checker_max_vm_size) },
  [META_PROBLEM_CONFIG_SECTION_checker_max_stack_size] = { META_PROBLEM_CONFIG_SECTION_checker_max_stack_size, 'Z', XSIZE(struct problem_config_section, checker_max_stack_size), "checker_max_stack_size", XOFFSET(struct problem_config_section, checker_max_stack_size) },
  [META_PROBLEM_CONFIG_SECTION_checker_max_rss_size] = { META_PROBLEM_CONFIG_SECTION_checker_max_rss_size, 'Z', XSIZE(struct problem_config_section, checker_max_rss_size), "checker_max_rss_size", XOFFSET(struct problem_config_section, checker_max_rss_size) },
