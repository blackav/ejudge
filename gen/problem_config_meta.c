...
static struct meta_info_item meta_info_problem_config_section_data[] =
{
  ...
  [META_PROBLEM_CONFIG_SECTION_enable_external_review] = { META_PROBLEM_CONFIG_SECTION_enable_external_review, 'f', XSIZE(struct problem_config_section, enable_external_review), "enable_external_review", XOFFSET(struct problem_config_section, enable_external_review) },
  [META_PROBLEM_CONFIG_SECTION_enable_user_review_request] = { META_PROBLEM_CONFIG_SECTION_enable_user_review_request, 'f', XSIZE(struct problem_config_section, enable_user_review_request), "enable_user_review_request", XOFFSET(struct problem_config_section, enable_user_review_request) },
  [META_PROBLEM_CONFIG_SECTION_enable_user_help_request] = { META_PROBLEM_CONFIG_SECTION_enable_user_help_request, 'f', XSIZE(struct problem_config_section, enable_user_help_request), "enable_user_help_request", XOFFSET(struct problem_config_section, enable_user_help_request) },
  [META_PROBLEM_CONFIG_SECTION_disable_pre_moderation] = { META_PROBLEM_CONFIG_SECTION_disable_pre_moderation, 'f', XSIZE(struct problem_config_section, disable_pre_moderation), "disable_pre_moderation", XOFFSET(struct problem_config_section, disable_pre_moderation) },
  [META_PROBLEM_CONFIG_SECTION_disable_post_approve] = { META_PROBLEM_CONFIG_SECTION_disable_post_approve, 'f', XSIZE(struct problem_config_section, disable_post_approve), "disable_post_approve", XOFFSET(struct problem_config_section, disable_post_approve) },
