...
static struct meta_info_item meta_info_compile_request_packet_data[] =
{
  ...
  [META_COMPILE_REQUEST_PACKET_enable_extended_status] = { META_COMPILE_REQUEST_PACKET_enable_extended_status, 'i', XSIZE(struct compile_request_packet, enable_extended_status), "enable_extended_status", XOFFSET(struct compile_request_packet, enable_extended_status) },
...
void meta_compile_request_packet_copy(struct compile_request_packet *dst, const struct compile_request_packet *src)
{
  ...
  dst->enable_extended_status = src->enable_extended_status;
  // submit_id
  // uuid
  // judge_uuid
