...
static const struct packet_handler packet_handlers[SSERV_CMD_LAST] =
{
  ...
  [_SSERV_CMD_CNTS_EDIT_USERS_HEADER] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_USERS_FOOTER] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_REGISTER_HEADER] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_REGISTER_FOOTER] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_TEAM_HEADER] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_TEAM_MENU_1] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_TEAM_MENU_2] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_TEAM_MENU_3] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_TEAM_SEPARATOR] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_TEAM_FOOTER] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_PRIV_HEADER] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_PRIV_FOOTER] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_COPYRIGHT] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_WELCOME] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_REG_WELCOME] = { cmd_main_page },
  [_SSERV_CMD_CNTS_EDIT_REGISTER_EMAIL_FILE] = { cmd_main_page },
  ...
  [_SSERV_CMD_GLOB_EDIT_CONTEST_START_CMD] = { cmd_main_page },
  [SSERV_CMD_GLOB_CHANGE_CONTEST_STOP_CMD] = { cmd_set_value },
  [SSERV_CMD_GLOB_CLEAR_CONTEST_STOP_CMD] = { cmd_set_value },
  [_SSERV_CMD_GLOB_EDIT_CONTEST_STOP_CMD] = { cmd_main_page },
