...
enum Dwarf_AT_e {
    ...
    DW_AT_ghs_namespace_alias                = 0x0806,
    DW_AT_ghs_using_namespace                = 0x0807,
    DW_AT_ghs_using_declaration              = 0x0808,
...
enum Dwarf_OP_e {
    ...
    DW_OP_WASM_location                      = 0x00ed,
    DW_OP_WASM_location_int                  = 0x00ee,
...
enum Dwarf_CC_e {
    ...
    DW_CC_GNU_BORLAND_safecall               = 0x00b0,
    DW_CC_GNU_BORLAND_stdcall                = 0x00b1,
    DW_CC_GNU_BORLAND_pascal                 = 0x00b2,
    DW_CC_GNU_BORLAND_msfastcall             = 0x00b3,
    DW_CC_GNU_BORLAND_msreturn               = 0x00b4,
    DW_CC_GNU_BORLAND_thiscall               = 0x00b5,
    DW_CC_GNU_BORLAND_fastcall               = 0x00b6,
    DW_CC_LLVM_vectorcall                    = 0x00c0,
    DW_CC_LLVM_Win64                         = 0x00c1,
    DW_CC_LLVM_X86_64SysV                    = 0x00c2,
    DW_CC_LLVM_AAPCS                         = 0x00c3,
    DW_CC_LLVM_AAPCS_VFP                     = 0x00c4,
    DW_CC_LLVM_IntelOclBicc                  = 0x00c5,
    DW_CC_LLVM_SpirFunction                  = 0x00c6,
    DW_CC_LLVM_OpenCLKernel                  = 0x00c7,
    DW_CC_LLVM_Swift                         = 0x00c8,
    DW_CC_LLVM_PreserveMost                  = 0x00c9,
    DW_CC_LLVM_PreserveAll                   = 0x00ca,
    DW_CC_LLVM_X86RegCall                    = 0x00cb,
    DW_CC_GDB_IBM_OpenCL                     = 0x00ff,
};
