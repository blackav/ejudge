...
enum
{
  ...
  _SSERV_CMD_CNTS_EDIT_USERS_HEADER,
  _SSERV_CMD_CNTS_EDIT_USERS_FOOTER,
  _SSERV_CMD_CNTS_EDIT_REGISTER_HEADER,
  _SSERV_CMD_CNTS_EDIT_REGISTER_FOOTER,
  _SSERV_CMD_CNTS_EDIT_TEAM_HEADER,
  _SSERV_CMD_CNTS_EDIT_TEAM_MENU_1,
  _SSERV_CMD_CNTS_EDIT_TEAM_MENU_2,
  _SSERV_CMD_CNTS_EDIT_TEAM_MENU_3,
  _SSERV_CMD_CNTS_EDIT_TEAM_SEPARATOR,
  _SSERV_CMD_CNTS_EDIT_TEAM_FOOTER,
  _SSERV_CMD_CNTS_EDIT_PRIV_HEADER,
  _SSERV_CMD_CNTS_EDIT_PRIV_FOOTER,
  _SSERV_CMD_CNTS_EDIT_COPYRIGHT,
  _SSERV_CMD_CNTS_EDIT_WELCOME,
  _SSERV_CMD_CNTS_EDIT_REG_WELCOME,
  _SSERV_CMD_CNTS_EDIT_REGISTER_EMAIL_FILE,
  ...
  _SSERV_CMD_GLOB_EDIT_CONTEST_START_CMD,
  SSERV_CMD_GLOB_CHANGE_CONTEST_STOP_CMD,
  SSERV_CMD_GLOB_CLEAR_CONTEST_STOP_CMD,
  _SSERV_CMD_GLOB_EDIT_CONTEST_STOP_CMD,
