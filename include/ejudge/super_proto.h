...
/* subcommands for SSERV_CMD_HTTP_REQUEST */
  SSERV_OP_VIEW_CNTS_DETAILS = SSERV_CMD_HTTP_REQUEST_FIRST,
  ...
  SSERV_OP_USER_BROWSE_PAGE,                   /* OK */
  SSERV_OP_USER_FILTER_CHANGE_ACTION,          /* OK */
  SSERV_OP_USER_FILTER_FIRST_PAGE_ACTION,      /* OK */
  SSERV_OP_USER_FILTER_PREV_PAGE_ACTION,       /* OK */
  SSERV_OP_USER_FILTER_NEXT_PAGE_ACTION,       /* OK */
  SSERV_OP_USER_FILTER_LAST_PAGE_ACTION,       /* OK */
  SSERV_OP_USER_JUMP_CONTEST_ACTION,
  SSERV_OP_USER_JUMP_GROUP_ACTION,
  SSERV_OP_USER_BROWSE_MARK_ALL_ACTION,
  SSERV_OP_USER_BROWSE_UNMARK_ALL_ACTION,
  SSERV_OP_USER_BROWSE_TOGGLE_ALL_ACTION,
  SSERV_OP_USER_CREATE_ONE_PAGE,               /* OK */
  SSERV_OP_USER_CREATE_ONE_ACTION,             /* OK */
  SSERV_OP_USER_CREATE_MANY_PAGE,              /* OK */
  SSERV_OP_USER_CREATE_MANY_ACTION,            /* OK */
  SSERV_OP_USER_CREATE_FROM_CSV_PAGE,          /* OK */
  SSERV_OP_USER_CREATE_FROM_CSV_ACTION,        /* OK */
  SSERV_OP_USER_DETAIL_PAGE,                   /* OK */
  SSERV_OP_USER_PASSWORD_PAGE,                 /* OK */
  SSERV_OP_USER_CHANGE_PASSWORD_ACTION,        /* OK */
  SSERV_OP_USER_CNTS_PASSWORD_PAGE,            /* OK */
  SSERV_OP_USER_CHANGE_CNTS_PASSWORD_ACTION,   /* OK */
  SSERV_OP_USER_CLEAR_FIELD_ACTION,
  SSERV_OP_USER_CREATE_MEMBER_ACTION,          /* OK */
  SSERV_OP_USER_DELETE_MEMBER_PAGE,            /* OK */
  SSERV_OP_USER_DELETE_MEMBER_ACTION,          /* OK */
  SSERV_OP_USER_SAVE_AND_PREV_ACTION,          /* OK */
  SSERV_OP_USER_SAVE_ACTION,                   /* OK */
  SSERV_OP_USER_SAVE_AND_NEXT_ACTION,          /* OK */
  SSERV_OP_USER_CANCEL_AND_PREV_ACTION,        /* OK */
  SSERV_OP_USER_CANCEL_ACTION,                 /* OK */
  SSERV_OP_USER_CANCEL_AND_NEXT_ACTION,        /* OK */
  SSERV_OP_USER_CREATE_REG_PAGE,               /* OK */
  SSERV_OP_USER_CREATE_REG_ACTION,             /* OK */
  SSERV_OP_USER_EDIT_REG_PAGE,                 /* OK */
  SSERV_OP_USER_EDIT_REG_ACTION,               /* OK */
  SSERV_OP_USER_DELETE_REG_PAGE,               /* OK */
  SSERV_OP_USER_DELETE_REG_ACTION,             /* OK */
  SSERV_OP_USER_DELETE_SESSION_ACTION,
  SSERV_OP_USER_DELETE_ALL_SESSIONS_ACTION,
  SSERV_OP_USER_SEL_RANDOM_PASSWD_PAGE,
  SSERV_OP_USER_SEL_RANDOM_PASSWD_ACTION,
  SSERV_OP_USER_SEL_CLEAR_CNTS_PASSWD_PAGE,
  SSERV_OP_USER_SEL_CLEAR_CNTS_PASSWD_ACTION,
  SSERV_OP_USER_SEL_RANDOM_CNTS_PASSWD_PAGE,
  SSERV_OP_USER_SEL_RANDOM_CNTS_PASSWD_ACTION,
  SSERV_OP_USER_SEL_CREATE_REG_PAGE,
  SSERV_OP_USER_SEL_CREATE_REG_ACTION,
  SSERV_OP_USER_SEL_CREATE_REG_AND_COPY_PAGE,
  SSERV_OP_USER_SEL_CREATE_REG_AND_COPY_ACTION,
  SSERV_OP_USER_SEL_DELETE_REG_PAGE,
  SSERV_OP_USER_SEL_DELETE_REG_ACTION,
  SSERV_OP_USER_SEL_CHANGE_REG_STATUS_PAGE,
  SSERV_OP_USER_SEL_CHANGE_REG_STATUS_ACTION,
  SSERV_OP_USER_SEL_CHANGE_REG_FLAGS_PAGE,
  SSERV_OP_USER_SEL_CHANGE_REG_FLAGS_ACTION,
  SSERV_OP_USER_SEL_CANCEL_ACTION,
  SSERV_OP_USER_SEL_VIEW_PASSWD_PAGE,
  SSERV_OP_USER_SEL_VIEW_CNTS_PASSWD_PAGE,
  SSERV_OP_USER_SEL_VIEW_PASSWD_REDIRECT,
  SSERV_OP_USER_SEL_VIEW_CNTS_PASSWD_REDIRECT,
  SSERV_OP_USER_SEL_CREATE_GROUP_MEMBER_PAGE,
  SSERV_OP_USER_SEL_CREATE_GROUP_MEMBER_ACTION,
  SSERV_OP_USER_SEL_DELETE_GROUP_MEMBER_PAGE,
  SSERV_OP_USER_SEL_DELETE_GROUP_MEMBER_ACTION,
  SSERV_OP_USER_IMPORT_CSV_PAGE,
  SSERV_OP_USER_IMPORT_CSV_ACTION,

  SSERV_OP_GROUP_BROWSE_PAGE,
  SSERV_OP_GROUP_FILTER_CHANGE_ACTION,
  ...
  SSERV_OP_GROUP_CREATE_PAGE,
  SSERV_OP_GROUP_CREATE_ACTION,
  SSERV_OP_GROUP_MODIFY_PAGE,
  SSERV_OP_GROUP_MODIFY_PAGE_ACTION,
  SSERV_OP_GROUP_MODIFY_ACTION,
  SSERV_OP_GROUP_DELETE_PAGE,
  SSERV_OP_GROUP_DELETE_PAGE_ACTION,
  SSERV_OP_GROUP_DELETE_ACTION,
  SSERV_OP_GROUP_CANCEL_ACTION,

  SSERV_OP_TESTS_MAIN_PAGE,
  SSERV_OP_TESTS_STATEMENT_EDIT_PAGE,
  SSERV_OP_TESTS_STATEMENT_EDIT_ACTION,
  SSERV_OP_TESTS_STATEMENT_EDIT_2_ACTION,
  SSERV_OP_TESTS_STATEMENT_EDIT_3_ACTION,
  SSERV_OP_TESTS_STATEMENT_EDIT_4_ACTION,
  SSERV_OP_TESTS_STATEMENT_EDIT_5_ACTION,
  SSERV_OP_TESTS_STATEMENT_DELETE_ACTION,
  SSERV_OP_TESTS_STATEMENT_DELETE_SAMPLE_ACTION,
  SSERV_OP_TESTS_TESTS_VIEW_PAGE,
  SSERV_OP_TESTS_CHECK_TESTS_PAGE,
  SSERV_OP_TESTS_GENERATE_ANSWERS_PAGE,
  SSERV_OP_TESTS_SOURCE_HEADER_EDIT_PAGE,
  SSERV_OP_TESTS_SOURCE_HEADER_EDIT_ACTION,
  SSERV_OP_TESTS_SOURCE_HEADER_DELETE_ACTION,
  SSERV_OP_TESTS_SOURCE_FOOTER_EDIT_PAGE,
  SSERV_OP_TESTS_SOURCE_FOOTER_EDIT_ACTION,
  SSERV_OP_TESTS_SOURCE_FOOTER_DELETE_ACTION,
  SSERV_OP_TESTS_SOLUTION_EDIT_PAGE,
  SSERV_OP_TESTS_SOLUTION_EDIT_ACTION,
  SSERV_OP_TESTS_SOLUTION_DELETE_ACTION,
  SSERV_OP_TESTS_STYLE_CHECKER_CREATE_PAGE,
  SSERV_OP_TESTS_STYLE_CHECKER_CREATE_ACTION,
  SSERV_OP_TESTS_STYLE_CHECKER_EDIT_PAGE,
  SSERV_OP_TESTS_STYLE_CHECKER_EDIT_ACTION,
  SSERV_OP_TESTS_STYLE_CHECKER_DELETE_PAGE,
  SSERV_OP_TESTS_STYLE_CHECKER_DELETE_ACTION,
  SSERV_OP_TESTS_CHECKER_CREATE_PAGE,
  SSERV_OP_TESTS_CHECKER_CREATE_ACTION,
  SSERV_OP_TESTS_CHECKER_EDIT_PAGE,
  SSERV_OP_TESTS_CHECKER_EDIT_ACTION,
  SSERV_OP_TESTS_CHECKER_DELETE_PAGE,
  SSERV_OP_TESTS_CHECKER_DELETE_ACTION,
  SSERV_OP_TESTS_VALUER_CREATE_PAGE,
  SSERV_OP_TESTS_VALUER_CREATE_ACTION,
  SSERV_OP_TESTS_VALUER_EDIT_PAGE,
  SSERV_OP_TESTS_VALUER_EDIT_ACTION,
  SSERV_OP_TESTS_VALUER_DELETE_PAGE,
  SSERV_OP_TESTS_VALUER_DELETE_ACTION,
  SSERV_OP_TESTS_INTERACTOR_CREATE_PAGE,
  SSERV_OP_TESTS_INTERACTOR_CREATE_ACTION,
  SSERV_OP_TESTS_INTERACTOR_EDIT_PAGE,
  SSERV_OP_TESTS_INTERACTOR_EDIT_ACTION,
  SSERV_OP_TESTS_INTERACTOR_DELETE_PAGE,
  SSERV_OP_TESTS_INTERACTOR_DELETE_ACTION,
  SSERV_OP_TESTS_TEST_CHECKER_CREATE_PAGE,
  SSERV_OP_TESTS_TEST_CHECKER_CREATE_ACTION,
  SSERV_OP_TESTS_TEST_CHECKER_EDIT_PAGE,
  SSERV_OP_TESTS_TEST_CHECKER_EDIT_ACTION,
  SSERV_OP_TESTS_TEST_CHECKER_DELETE_PAGE,
  SSERV_OP_TESTS_TEST_CHECKER_DELETE_ACTION,
  SSERV_OP_TESTS_INIT_CREATE_PAGE,
  SSERV_OP_TESTS_INIT_CREATE_ACTION,
  SSERV_OP_TESTS_INIT_EDIT_PAGE,
  SSERV_OP_TESTS_INIT_EDIT_ACTION,
  SSERV_OP_TESTS_INIT_DELETE_PAGE,
  SSERV_OP_TESTS_INIT_DELETE_ACTION,
  SSERV_OP_TESTS_MAKEFILE_EDIT_PAGE,
  SSERV_OP_TESTS_MAKEFILE_EDIT_ACTION,
  SSERV_OP_TESTS_MAKEFILE_DELETE_ACTION,
  SSERV_OP_TESTS_MAKEFILE_GENERATE_ACTION,
  SSERV_OP_TESTS_TEST_MOVE_UP_ACTION,
  SSERV_OP_TESTS_TEST_MOVE_DOWN_ACTION,
  SSERV_OP_TESTS_TEST_MOVE_TO_SAVED_ACTION,
  SSERV_OP_TESTS_TEST_INSERT_PAGE,
  SSERV_OP_TESTS_TEST_INSERT_ACTION,
  SSERV_OP_TESTS_TEST_EDIT_PAGE,
  SSERV_OP_TESTS_TEST_EDIT_ACTION,
  SSERV_OP_TESTS_TEST_DELETE_PAGE,
  SSERV_OP_TESTS_TEST_DELETE_ACTION,
  SSERV_OP_TESTS_TEST_UPLOAD_ARCHIVE_1_PAGE,
  SSERV_OP_TESTS_TEST_CHECK_ACTION,
  SSERV_OP_TESTS_TEST_GENERATE_ACTION,
  SSERV_OP_TESTS_SAVED_MOVE_UP_ACTION,
  SSERV_OP_TESTS_SAVED_MOVE_DOWN_ACTION,
  SSERV_OP_TESTS_SAVED_DELETE_PAGE,
  SSERV_OP_TESTS_SAVED_MOVE_TO_TEST_ACTION,
  SSERV_OP_TESTS_README_CREATE_PAGE,
  SSERV_OP_TESTS_README_EDIT_PAGE,
  SSERV_OP_TESTS_README_DELETE_PAGE,
  SSERV_OP_TESTS_CANCEL_ACTION,
  SSERV_OP_TESTS_CANCEL_2_ACTION,
  SSERV_OP_TESTS_TEST_DOWNLOAD,
  SSERV_OP_TESTS_TEST_UPLOAD_PAGE,
  SSERV_OP_TESTS_TEST_CLEAR_INF_ACTION,
  SSERV_OP_TESTS_MAKE,

  SSERV_OP_USER_MAP_MAIN_PAGE,
  SSERV_OP_USER_MAP_DELETE_ACTION,
  SSERV_OP_USER_MAP_ADD_ACTION,

  SSERV_OP_CAPS_MAIN_PAGE,
  SSERV_OP_CAPS_DELETE_ACTION,
  SSERV_OP_CAPS_ADD_ACTION,
  SSERV_OP_CAPS_EDIT_PAGE,
  SSERV_OP_CAPS_EDIT_SAVE_ACTION,
  SSERV_OP_CAPS_EDIT_CANCEL_ACTION,

  SSERV_OP_EJUDGE_XML_UPDATE_ACTION,
  SSERV_OP_EJUDGE_XML_CANCEL_ACTION,
  SSERV_OP_EJUDGE_XML_MUST_RESTART,

  SSERV_OP_IMPORT_FROM_POLYGON_PAGE,
  SSERV_OP_IMPORT_FROM_POLYGON_ACTION,
  SSERV_OP_DOWNLOAD_PROGRESS_PAGE,
  SSERV_OP_DOWNLOAD_CLEANUP_ACTION,
  SSERV_OP_DOWNLOAD_KILL_ACTION,
  SSERV_OP_DOWNLOAD_CLEANUP_AND_CHECK_ACTION,
  ...
  SSERV_OP_IMPORT_CONTEST_FROM_POLYGON_PAGE,

  SSERV_OP_LAST,

  SSERV_CMD_LAST = SSERV_OP_LAST,
};
...
enum
{
  ...
  S_ERR_INV_SERVE_CONFIG_PATH,
  S_ERR_INV_VARIANT,
  S_ERR_UNSUPPORTED_SETTINGS,
  S_ERR_INV_CNTS_SETTINGS,
  S_ERR_INV_TEST_NUM,
  S_ERR_FS_ERROR,
  S_ERR_INV_EXIT_CODE,
  S_ERR_INV_SYS_GROUP,
