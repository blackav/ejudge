...
enum
{
  ...
  NEW_SRV_ACTION_VCS_WEBHOOK,
  NEW_SRV_ACTION_SUBMIT_RUN_INPUT,
  NEW_SRV_ACTION_GET_SUBMIT,
  NEW_SRV_ACTION_GET_USERPROB,
  ...
  NEW_SRV_ACTION_REQUEST_REVIEW_JSON,
  NEW_SRV_ACTION_LIST_REVIEWS_JSON,
  NEW_SRV_ACTION_GET_REVIEW_JSON,
  NEW_SRV_ACTION_UPDATE_REVIEW_JSON,
  NEW_SRV_ACTION_PREMODERATE_JSON,
  NEW_SRV_ACTION_LIST_PENDING_REVIEWS_JSON,
  NEW_SRV_ACTION_START_REVIEW_JSON,
  NEW_SRV_ACTION_FINISH_REVIEW_JSON,
  NEW_SRV_ACTION_HEARTBEAT_REVIEW_JSON,
  NEW_SRV_ACTION_LIST_ACTIVE_REVIEWS_JSON,
  NEW_SRV_ACTION_GET_ACTIVE_REVIEW_JSON,
  NEW_SRV_ACTION_POSTAPPROVE_JSON,
  NEW_SRV_ACTION_REVIEWS_PAGE,
  NEW_SRV_ACTION_PREMODERATE_PAGE,
  NEW_SRV_ACTION_POSTAPPROVE_PAGE,
  NEW_SRV_ACTION_REVIEW_DISPLAYED_1,
  NEW_SRV_ACTION_REVIEW_DISPLAYED_2,
  NEW_SRV_ACTION_REVIEW_OPERATION_JSON,
...
enum
{
  ...
  NEW_SRV_ERR_RATE_EXCEEDED,
  NEW_SRV_ERR_INV_SUBMIT_ID,
  NEW_SRV_ERR_INV_USERPROB_ID,
  NEW_SRV_ERR_INV_EXT_USER,
  NEW_SRV_ERR_INV_NOTIFY,
  NEW_SRV_ERR_ALREADY_EXISTS,
  NEW_SRV_ERR_USER_NOT_REGISTERED,
  NEW_SRV_ERR_USER_BANNED,
  NEW_SRV_ERR_USER_LOCKED,
  NEW_SRV_ERR_NO_CONTESTS,
  NEW_SRV_ERR_NO_AFFECTED_ROWS,
  NEW_SRV_ERR_RUN_REVIEW_QUOTA_EXCEEDED,
  NEW_SRV_ERR_RUN_ALREADY_REVIEWED,
  NEW_SRV_ERR_RUN_REVIEW_INCOMPLETE,
  NEW_SRV_ERR_RUN_REVIEW_INV_STATE,
