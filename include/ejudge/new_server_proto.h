...
enum
{
  ...
  // these actions are internal, cannot be invoked from web
  NEW_SRV_ACTION_INT_ACM_STANDINGS,
  NEW_SRV_ACTION_INT_KIROV_STANDINGS,
  NEW_SRV_ACTION_INT_MOSCOW_STANDINGS,
  NEW_SRV_ACTION_INT_OLYMP_ACCEPTING_STANDINGS,
  NEW_SRV_ACTION_INT_PUBLIC_LOG,
