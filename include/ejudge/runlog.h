...
enum
{
  ...
  RER_REVIEW_SOURCE = 0x2000ULL,
  RER_REVIEW_AGENT = 0x4000ULL,
  RER_REVIEW_HEARTBEAT_STATUS = 0x8000ULL,
  RER_REVIEW_RESULT = 0x10000ULL,
  RER_REVIEW_JUDGE_RESULT = 0x20000ULL,
  RER_REVIEW_STATISTICS = 0x40000ULL,
  RER_REVIEW_LOG = 0x80000ULL,
  RER_APPROVED_TEXT = 0x100000ULL,
  RER_JUDGE_APPROVED_TEXT = 0x200000ULL,
  RER_MODEL = 0x400000ULL,
  RER_APPROVER_FEEDBACK = 0x800000ULL,
  RER_USER_FEEDBACK = 0x1000000ULL,
  RER_REVIEW_SOURCE_SHA256 = 0x2000000ULL,
  RER_CONTEST_ID = 0x4000000ULL,
  RER_RUN_ID = 0x8000000ULL,
  RER_REQUEST_USER_ID = 0x10000000ULL,
  RER_MODERATOR_USER_ID = 0x20000000ULL,
  RER_REVIEWER_USER_ID = 0x40000000ULL,
  RER_APPROVER_USER_ID = 0x80000000ULL,
  RER_INPUT_TOKENS = 0x100000000ULL,
  RER_CACHED_INPUT_TOKENS = 0x200000000ULL,
  RER_OUPUT_TOKENS = 0x400000000ULL,
  RER_REASONING_TOKENS = 0x800000000ULL,
  RER_TOTAL_TOKENS = 0x1000000000ULL,
  RER_GENERATION = 0x2000000000ULL,
  RER_STATUS = 0x4000000000ULL,
  RER_PURPOSE = 0x8000000000ULL,
  RER_REVIEW_RECOMMENDED_STATUS = 0x10000000000ULL,
  RER_APPROVER_REVIEW_MARK = 0x20000000000ULL,
  RER_USER_OPENED_COUNT = 0x40000000000ULL,
  RER_USER_REVIEW_MARK = 0x80000000000ULL,
  RER_REVIEW_APPROVED_AS_IS = 0x100000000000ULL,
  RER_STATUS_APPROVED_AS_IS = 0x200000000000ULL,
  RER_AI_GENERATION_SCORE = 0x400000000000ULL,

  RER_ALL = 0x7FFFFFFFFFFFULL,
};
