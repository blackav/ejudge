...
enum
{
  ...
  RER_INPUT_TOKENS = 0x8000000ULL,
  RER_CACHED_INPUT_TOKENS = 0x10000000ULL,
  RER_OUPUT_TOKENS = 0x20000000ULL,
  RER_REASONING_TOKENS = 0x40000000ULL,
  RER_TOTAL_TOKENS = 0x80000000ULL,
  RER_GENERATION = 0x100000000ULL,
  RER_STATUS = 0x200000000ULL,
  ...
  RER_AI_GENERATION_SCORE = 0x20000000000ULL,

  RER_ALL = 0x3FFFFFFFFFFULL,
};
