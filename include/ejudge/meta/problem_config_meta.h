...
enum
{
  ...
  META_PROBLEM_CONFIG_SECTION_enable_dynamic_priority,
  ...
  META_PROBLEM_CONFIG_SECTION_autoassign_variants,
  ...
  META_PROBLEM_CONFIG_SECTION_notify_on_submit,
  META_PROBLEM_CONFIG_SECTION_enable_user_input,
  META_PROBLEM_CONFIG_SECTION_enable_vcs,
  ...
  META_PROBLEM_CONFIG_SECTION_enable_external_review,
  META_PROBLEM_CONFIG_SECTION_enable_user_review_request,
  META_PROBLEM_CONFIG_SECTION_enable_user_help_request,
  META_PROBLEM_CONFIG_SECTION_disable_pre_moderation,
  META_PROBLEM_CONFIG_SECTION_disable_post_approve,
  ...
  META_PROBLEM_CONFIG_SECTION_debug_flags,
  META_PROBLEM_CONFIG_SECTION_communication,
  ...
  META_PROBLEM_CONFIG_SECTION_checker_max_vm_size,
  META_PROBLEM_CONFIG_SECTION_checker_max_stack_size,
  META_PROBLEM_CONFIG_SECTION_checker_max_rss_size,
  ...
  META_PROBLEM_CONFIG_SECTION_stand_column,
  META_PROBLEM_CONFIG_SECTION_group_name,
  META_PROBLEM_CONFIG_SECTION_internal_name,
  META_PROBLEM_CONFIG_SECTION_plugin_entry_name,
  META_PROBLEM_CONFIG_SECTION_uuid,
  META_PROBLEM_CONFIG_SECTION_test_dir,
  META_PROBLEM_CONFIG_SECTION_test_sfx,
  META_PROBLEM_CONFIG_SECTION_corr_dir,
  META_PROBLEM_CONFIG_SECTION_corr_sfx,
  META_PROBLEM_CONFIG_SECTION_info_dir,
  META_PROBLEM_CONFIG_SECTION_info_sfx,
  META_PROBLEM_CONFIG_SECTION_tgz_dir,
  ...
  META_PROBLEM_CONFIG_SECTION_statement_file,
  ...
  META_PROBLEM_CONFIG_SECTION_custom_compile_cmd,
  META_PROBLEM_CONFIG_SECTION_custom_lang_name,
  META_PROBLEM_CONFIG_SECTION_extra_src_dir,
  META_PROBLEM_CONFIG_SECTION_standard_valuer,
  META_PROBLEM_CONFIG_SECTION_md_file,
  ...
  META_PROBLEM_CONFIG_SECTION_test_generator_cmd,
  ...
  META_PROBLEM_CONFIG_SECTION_post_pull_cmd,
  META_PROBLEM_CONFIG_SECTION_vcs_compile_cmd,
  ...
  META_PROBLEM_CONFIG_SECTION_src_normalization,
  META_PROBLEM_CONFIG_SECTION_score_bonus,
  META_PROBLEM_CONFIG_SECTION_super_run_dir,
  META_PROBLEM_CONFIG_SECTION_exchange_dir,
  META_PROBLEM_CONFIG_SECTION_communication_flags,
  ...
  META_PROBLEM_CONFIG_SECTION_allow_ip,
  ...
  META_PROBLEM_CONFIG_SECTION_checker_extra_files,
  ...
  META_PROBLEM_CONFIG_SECTION_test_generator_env,
