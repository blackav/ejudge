...
enum
{
  ...
  META_COMPILE_REQUEST_PACKET_user_id,
  ...
  META_COMPILE_REQUEST_PACKET_enable_network,
  ...
  META_COMPILE_REQUEST_PACKET_max_rss_size,
  ...
  META_COMPILE_REQUEST_PACKET_user_login,
  META_COMPILE_REQUEST_PACKET_exam_cypher,
  META_COMPILE_REQUEST_PACKET_contest_server_id,
  META_COMPILE_REQUEST_PACKET_container_options,
  META_COMPILE_REQUEST_PACKET_vcs_compile_cmd,
  META_COMPILE_REQUEST_PACKET_compile_cmd,
  META_COMPILE_REQUEST_PACKET_extra_src_dir,
