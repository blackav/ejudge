...
" !#$%\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[]^_"
"`abcdefghijklmnopqrstuvwxyz{|}~†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø"
  ...
  while (1) {
    ...
    while (1) {
      ...
      case 'd': case 'D': case '˜' & 255: case '◊' & 255:
        c = 'd';
        goto menu_done;
      case 'q': case 'Q': case ' ' & 255: case 'Í' & 255: case 'G' & 31:
        c = 'q';
        goto menu_done;
      case 'b': case 'B': case '…' & 255: case 'È' & 255:
        c = 'b';
        goto menu_done;
      case '\n': case '\r':
        c = '\n';
...
generate_install_script(FILE *f)
{
  ...
  fprintf(f, "cat << _EOF | uudecode -o - | tar xvfz - -C \"%s\"\n",
          config_contest1_home_dir);
  fprintf(f, "%s_EOF\n", b64_contest1_tgz);
...
/*
 *  compile-command: "gcc -D_GNU_SOURCE -Wall -g -I. -I/home/cher/reuse/include -I/home/cher/reuse/include/ix86-linux -L. -L/home/cher/reuse/lib/ix86-linux ejudge-setup.c version.o -o ejudge-setup -lcommon -lreuse -lmenu -lpanel -lncurses -lm"
 */
