...
enum
{
  ...
  SSERV_OP_TESTS_EDIT_STATEMENT_PAGE,
  SSERV_OP_TESTS_VIEW_TESTS_PAGE,
  SSERV_OP_TESTS_EDIT_SOURCE_HEADER_PAGE,
  SSERV_OP_TESTS_EDIT_SOURCE_FOOTER_PAGE,
  SSERV_OP_TESTS_EDIT_STYLE_CHECKER_PAGE,
  SSERV_OP_TESTS_EDIT_CHECKER_PAGE,
  SSERV_OP_TESTS_EDIT_VALUER_PAGE,
  SSERV_OP_TESTS_EDIT_INTERACTOR_PAGE,
  SSERV_OP_TESTS_EDIT_TEST_CHECKER_PAGE,
