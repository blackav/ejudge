...
enum
{
  ...
  SSERV_OP_BROWSE_USERS,
  SSERV_OP_CHANGE_USER_FILTER,
  SSERV_OP_USER_FILTER_FIRST_PAGE,
  SSERV_OP_USER_FILTER_PREV_PAGE,
  SSERV_OP_USER_FILTER_NEXT_PAGE,
  SSERV_OP_USER_FILTER_LAST_PAGE,
  SSERV_OP_USER_DETAIL_PAGE,
  SSERV_OP_USER_PASSWORD_PAGE,
  SSERV_OP_BROWSE_GROUPS,
  SSERV_OP_CHANGE_GROUP_FILTER,
  SSERV_OP_GROUP_FILTER_FIRST_PAGE,
  SSERV_OP_GROUP_FILTER_PREV_PAGE,
  SSERV_OP_GROUP_FILTER_NEXT_PAGE,
  SSERV_OP_GROUP_FILTER_LAST_PAGE,
