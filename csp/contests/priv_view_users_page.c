...
#line 116 "priv_view_users_page.csp"
if (global->memoize_user_results > 0) {
fwrite(csp_str10, 1, 27, out_f);

#line 118 "priv_view_users_page.csp"
}
...
#line 127 "priv_view_users_page.csp"
...
#line 176 "priv_view_users_page.csp"
}
fwrite(csp_str15, 1, 1, out_f);
...
#line 179 "priv_view_users_page.csp"
}
fwrite(csp_str22, 1, 50, out_f);
fprintf(out_f, "%d", (int)(uid));
fwrite(csp_str23, 1, 15, out_f);

#line 182 "priv_view_users_page.csp"
}
...
#line 209 "priv_view_users_page.csp"
...
#line 215 "priv_view_users_page.csp"
}
fwrite(csp_str15, 1, 1, out_f);
...
#line 218 "priv_view_users_page.csp"
}
fwrite(csp_str15, 1, 1, out_f);

#line 219 "priv_view_users_page.csp"
if (global->full_exam_protocol_header_txt) {
fwrite(csp_str30, 1, 9, out_f);
...
#line 221 "priv_view_users_page.csp"
}
...
#line 245 "priv_view_users_page.csp"
l10n_setlocale(0);
