...
static const unsigned char csp_str14[40] = "\n<table class=\"b0\">\n<tr><td class=\"b0\">";
static const unsigned char csp_str15[22] = ":</td><td class=\"b0\">";
static const unsigned char csp_str16[12] = "</td></tr>\n";
static const unsigned char csp_str17[21] = "\n<tr><td class=\"b0\">";
static const unsigned char csp_str18[2] = ".";
static const unsigned char csp_str19[21] = "</td><td class=\"b0\">";
...
static const unsigned char csp_str23[11] = "</td><tr>\n";
static const unsigned char csp_str24[49] = "\n<tr><td class=\"b0\">Variant:</td><td class=\"b0\">";
static const unsigned char csp_str25[53] = "\n<tr><td class=\"b0\">Lang name/ID</td><td class=\"b0\">";
static const unsigned char csp_str26[50] = "\n<option value=\"0\" selected=\"selected\"></option>\n";
static const unsigned char csp_str27[60] = "</td></tr>\n<tr><td class=\"b0\">EOLN Type</td><td class=\"b0\">";
static const unsigned char csp_str28[30] = "\n<option value=\"0\"></option>\n";
static const unsigned char csp_str29[16] = "LF (Unix/MacOS)";
static const unsigned char csp_str30[19] = "CRLF (Windows/DOS)";
static const unsigned char csp_str31[31] = "</td></tr>\n<tr><td class=\"b0\">";
static const unsigned char csp_str32[6] = "</td>";
...
fwrite(csp_str9, 1, 1, out_f);
fputs("</select>", out_f);
fwrite(csp_str27, 1, 59, out_f);
fputs("<select name=\"eoln_type\"", out_f);
if (info.is_readonly) {
fputs(" disabled=\"disabled\"", out_f);
}
fputs(">", out_f);
fwrite(csp_str28, 1, 29, out_f);
fputs("<option", out_f);
if (info.eoln_type == 1) {
fputs(" selected=\"selected\"", out_f);
}
...
fputs("\"", out_f);
fputs(">", out_f);
fwrite(csp_str30, 1, 18, out_f);
fputs("</option>", out_f);
fwrite(csp_str9, 1, 1, out_f);
fputs("</select>", out_f);
fwrite(csp_str31, 1, 30, out_f);
