...
extern int
csp_view_int_olymp_accept_standings(
        PageInterface *ps,
        FILE *log_f,
        FILE *out_f,
        struct http_request_info *phr);
static int
csp_execute_int_olymp_accept_standings(
        PageInterface *ps,
        FILE *log_f,
        struct http_request_info *phr);
static void
csp_destroy_int_olymp_accept_standings(
        PageInterface *ps);
...
PageInterface *
csp_get_int_olymp_accept_standings(void)
{
  /*
