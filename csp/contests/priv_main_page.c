...
fputs("<a href=\"", out_f);
sep = ns_url_2(out_f, phr, NEW_SRV_ACTION_PRIV_USERS_VIEW);
fputs("\">", out_f);
fputs(_("View privileged users"), out_f);
fputs("</a>", out_f);
fwrite(csp_str12, 1, 14, out_f);
fputs("<a href=\"", out_f);
sep = ns_url_2(out_f, phr, NEW_SRV_ACTION_VIEW_ONLINE_USERS);
fputs("\">", out_f);
fputs(_("View who is currently online"), out_f);
fputs("</a>", out_f);
fwrite(csp_str12, 1, 14, out_f);
fputs("<a href=\"", out_f);
sep = ns_url_2(out_f, phr, NEW_SRV_ACTION_VIEW_EXAM_INFO);
fputs("\">", out_f);
...
fputs("<a href=\"", out_f);
sep = ns_url_2(out_f, phr, NEW_SRV_ACTION_EXAMINERS_PAGE);
fputs("\">", out_f);
...
fwrite(csp_str14, 1, 13, out_f);
fputs("<a href=\"", out_f);
sep = ns_url_2(out_f, phr, NEW_SRV_ACTION_VIEW_USER_DUMP);
fputs("\">", out_f);
...
fwrite(csp_str14, 1, 13, out_f);
fputs("<a href=\"", out_f);
sep = ns_url_2(out_f, phr, NEW_SRV_ACTION_VIEW_RUNS_DUMP);
fputs("\">", out_f);
fputs(_("Dump runs in CSV format"), out_f);
fputs("</a>", out_f);
fwrite(csp_str19, 1, 18, out_f);
fputs("<a href=\"", out_f);
sep = ns_url_2(out_f, phr, NEW_SRV_ACTION_EXPORT_XML_RUNS);
fputs("\">", out_f);
fputs(_("Export runs in XML external format"), out_f);
fputs("</a>", out_f);
fwrite(csp_str19, 1, 18, out_f);
fputs("<a href=\"", out_f);
sep = ns_url_2(out_f, phr, NEW_SRV_ACTION_WRITE_XML_RUNS);
fputs("\">", out_f);
fputs(_("Write runs in XML internal format"), out_f);
fputs("</a>", out_f);
fwrite(csp_str19, 1, 18, out_f);
fputs("<a href=\"", out_f);
sep = ns_url_2(out_f, phr, NEW_SRV_ACTION_WRITE_XML_RUNS_WITH_SRC);
fputs("\">", out_f);
...
fwrite(csp_str15, 1, 9, out_f);
fputs("<a href=\"", out_f);
sep = ns_url_2(out_f, phr, NEW_SRV_ACTION_ASSIGN_CYPHERS_1);
fputs("\">", out_f);
fputs(_("Assign random cyphers"), out_f);
fputs("</a>", out_f);
fwrite(csp_str12, 1, 14, out_f);
fputs("<a href=\"", out_f);
sep = ns_url_2(out_f, phr, NEW_SRV_ACTION_VIEW_IP_USERS);
fputs("\">", out_f);
fputs(_("View users for IP addresses"), out_f);
fputs("</a>", out_f);
fwrite(csp_str12, 1, 14, out_f);
fputs("<a href=\"", out_f);
sep = ns_url_2(out_f, phr, NEW_SRV_ACTION_VIEW_USER_IPS);
fputs("\">", out_f);
