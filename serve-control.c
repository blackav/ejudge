...
static const int next_action_map[SSERV_CMD_LAST] =
{
  ...
  [SSERV_CMD_PROB_CHANGE_SHORT_NAME] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_SHORT_NAME] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_LONG_NAME] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_LONG_NAME] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_STAND_NAME] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_STAND_NAME] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_STAND_COLUMN] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_STAND_COLUMN] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_INTERNAL_NAME] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_INTERNAL_NAME] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SUPER] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TYPE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SCORING_CHECKER] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_INTERACTIVE_VALUER] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DISABLE_PE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DISABLE_WTL] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_MANUAL_CHECKING] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_EXAMINATOR_NUM] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_CHECK_PRESENTATION] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_USE_STDIN] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_USE_STDOUT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_COMBINED_STDIN] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_COMBINED_STDOUT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_BINARY_INPUT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_BINARY] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_IGNORE_EXIT_CODE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_OLYMPIAD_MODE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SCORE_LATEST] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SCORE_LATEST_OR_UNMARKED] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SCORE_LATEST_MARKED] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SCORE_TOKENIZED] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TIME_LIMIT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TIME_LIMIT_MILLIS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_REAL_TIME_LIMIT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_USE_AC_NOT_OK] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_IGNORE_PREV_AC] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TEAM_ENABLE_REP_VIEW] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TEAM_ENABLE_CE_VIEW] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TEAM_SHOW_JUDGE_REPORT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SHOW_CHECKER_COMMENT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_IGNORE_COMPILE_ERRORS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DISABLE_USER_SUBMIT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DISABLE_TAB] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_UNRESTRICTED_STATEMENT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_HIDE_FILE_NAMES] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_HIDE_REAL_TIME_LIMIT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_ENABLE_TOKENS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TOKENS_FOR_USER_AC] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DISABLE_SUBMIT_AFTER_OK] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DISABLE_SECURITY] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DISABLE_TESTING] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DISABLE_AUTO_TESTING] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_ENABLE_COMPILATION] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_FULL_SCORE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_FULL_USER_SCORE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TEST_SCORE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_RUN_PENALTY] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_ACM_RUN_PENALTY] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_MAX_USER_RUN_COUNT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DISQUALIFIED_PENALTY] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_VARIABLE_FULL_SCORE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TEST_SCORE_LIST] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TEST_SCORE_LIST] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TOKENS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TOKENS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_UMASK] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_UMASK] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_OK_STATUS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_OK_STATUS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SCORE_TESTS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_SCORE_TESTS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TESTS_TO_ACCEPT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_ACCEPT_PARTIAL] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_MIN_TESTS_TO_ACCEPT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_HIDDEN] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_STAND_HIDE_TIME] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_ADVANCE_TO_NEXT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DISABLE_CTRL_CHARS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_VALUER_SETS_MARKED] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_IGNORE_UNMARKED] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DISABLE_STDERR] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_ENABLE_PROCESS_GROUP] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_HIDE_VARIANT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_AUTOASSIGN_VARIANTS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_ENABLE_TEXT_FORM] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_STAND_IGNORE_SCORE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_STAND_LAST_COLUMN] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_CHECKER_REAL_TIME_LIMIT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_INTERACTOR_TIME_LIMIT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_MAX_VM_SIZE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_MAX_STACK_SIZE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_MAX_CORE_SIZE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_MAX_FILE_SIZE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_MAX_OPEN_FILE_COUNT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_MAX_PROCESS_COUNT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_INPUT_FILE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_INPUT_FILE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_OUTPUT_FILE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_OUTPUT_FILE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_USE_CORR] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_USE_INFO] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_USE_TGZ] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TEST_DIR] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TEST_DIR] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_CORR_DIR] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_CORR_DIR] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_INFO_DIR] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_INFO_DIR] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TEST_SFX] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TEST_SFX] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TEST_PAT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TEST_PAT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_CORR_SFX] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_CORR_SFX] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_CORR_PAT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_CORR_PAT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_INFO_SFX] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_INFO_SFX] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_INFO_PAT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_INFO_PAT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TGZ_SFX] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TGZ_SFX] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TGZ_PAT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TGZ_PAT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TGZDIR_SFX] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TGZDIR_SFX] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TGZDIR_PAT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TGZDIR_PAT] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_STANDARD_CHECKER] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SCORE_BONUS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_SCORE_BONUS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_OPEN_TESTS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_OPEN_TESTS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_FINAL_OPEN_TESTS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_FINAL_OPEN_TESTS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TOKEN_OPEN_TESTS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TOKEN_OPEN_TESTS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_LANG_COMPILER_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_LANG_COMPILER_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_CHECK_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_CHECK_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_CHECKER_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_CHECKER_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_VALUER_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_VALUER_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_VALUER_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_VALUER_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_INTERACTOR_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_INTERACTOR_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_INTERACTOR_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_INTERACTOR_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_STYLE_CHECKER_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_STYLE_CHECKER_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_STYLE_CHECKER_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_STYLE_CHECKER_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TEST_CHECKER_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TEST_CHECKER_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TEST_CHECKER_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TEST_CHECKER_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_INIT_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_INIT_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_START_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_START_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_INIT_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_INIT_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_START_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_START_ENV] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SOLUTION_SRC] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_SOLUTION_SRC] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SOLUTION_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_SOLUTION_CMD] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_LANG_TIME_ADJ] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_LANG_TIME_ADJ] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_LANG_TIME_ADJ_MILLIS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_LANG_TIME_ADJ_MILLIS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_LANG_MAX_VM_SIZE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_LANG_MAX_VM_SIZE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_LANG_MAX_STACK_SIZE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_LANG_MAX_STACK_SIZE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DISABLE_LANGUAGE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_DISABLE_LANGUAGE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_ENABLE_LANGUAGE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_ENABLE_LANGUAGE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_REQUIRE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_REQUIRE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_PROVIDE_OK] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_PROVIDE_OK] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_TEST_SETS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_TEST_SETS] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SCORE_VIEW] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_SCORE_VIEW] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_START_DATE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_START_DATE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_DEADLINE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_DEADLINE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_VARIANT_NUM] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  ...
  [SSERV_CMD_PROB_CHANGE_XML_FILE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_XML_FILE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_ALTERNATIVES_FILE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_ALTERNATIVES_FILE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_PLUGIN_FILE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_PLUGIN_FILE] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_STAND_ATTR] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_STAND_ATTR] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SOURCE_HEADER] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_SOURCE_HEADER] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_SOURCE_FOOTER] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_SOURCE_FOOTER] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CHANGE_NORMALIZATION] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
  [SSERV_CMD_PROB_CLEAR_NORMALIZATION] = SSERV_CMD_CNTS_EDIT_CUR_PROBLEMS_PAGE,
