...
static const int next_action_map[SSERV_CMD_LAST] =
{
  ...
  [SSERV_CMD_PROB_CHANGE_STAND_NAME] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_STAND_NAME] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_STAND_COLUMN] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_STAND_COLUMN] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_INTERNAL_NAME] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_INTERNAL_NAME] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_INTERACTIVE_VALUER] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_DISABLE_PE] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_DISABLE_WTL] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_COMBINED_STDIN] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_COMBINED_STDOUT] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_BINARY_INPUT] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_BINARY] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_USE_AC_NOT_OK] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_IGNORE_PREV_AC] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_SHOW_CHECKER_COMMENT] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_IGNORE_COMPILE_ERRORS] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_DISABLE_USER_SUBMIT] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_DISABLE_TAB] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_RESTRICTED_STATEMENT] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_DISABLE_SUBMIT_AFTER_OK] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_DISABLE_SECURITY] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_FULL_USER_SCORE] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_MAX_USER_RUN_COUNT] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_DISABLE_CTRL_CHARS] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_VALUER_SETS_MARKED] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_IGNORE_UNMARKED] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_DISABLE_STDERR] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_ENABLE_PROCESS_GROUP] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_ENABLE_TEXT_FORM] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_STAND_IGNORE_SCORE] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_STAND_LAST_COLUMN] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_CHECKER_REAL_TIME_LIMIT] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_INTERACTOR_TIME_LIMIT] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_MAX_CORE_SIZE] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_MAX_FILE_SIZE] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_MAX_OPEN_FILE_COUNT] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_MAX_PROCESS_COUNT] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_TGZ_SFX] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_TGZ_SFX] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_TGZ_PAT] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_TGZ_PAT] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_TGZDIR_SFX] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_TGZDIR_SFX] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_TGZDIR_PAT] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_TGZDIR_PAT] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_OPEN_TESTS] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_OPEN_TESTS] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_FINAL_OPEN_TESTS] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_FINAL_OPEN_TESTS] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_LANG_COMPILER_ENV] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_LANG_COMPILER_ENV] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_VALUER_CMD] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_VALUER_CMD] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_VALUER_ENV] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_VALUER_ENV] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_INTERACTOR_CMD] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_INTERACTOR_CMD] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_INTERACTOR_ENV] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_INTERACTOR_ENV] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_STYLE_CHECKER_CMD] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_STYLE_CHECKER_CMD] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_STYLE_CHECKER_ENV] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_STYLE_CHECKER_ENV] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_TEST_CHECKER_CMD] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_START_ENV] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_START_ENV] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CLEAR_SOLUTION_CMD] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_LANG_MAX_VM_SIZE] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_LANG_MAX_VM_SIZE] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_LANG_MAX_STACK_SIZE] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_LANG_MAX_STACK_SIZE] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_PROVIDE_OK] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_PROVIDE_OK] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_TEST_SETS] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_TEST_SETS] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_SCORE_VIEW] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_SCORE_VIEW] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_XML_FILE] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_XML_FILE] = SSERV_CMD_EDIT_CURRENT_PROB,
  ...
  [SSERV_CMD_PROB_CHANGE_PLUGIN_FILE] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_PLUGIN_FILE] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_PLUGIN_FILE] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_PLUGIN_FILE] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_STAND_ATTR] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_STAND_ATTR] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_SOURCE_HEADER] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_SOURCE_HEADER] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_SOURCE_FOOTER] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_SOURCE_FOOTER] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CHANGE_NORMALIZATION] = SSERV_CMD_EDIT_CURRENT_PROB,
  [SSERV_CMD_PROB_CLEAR_NORMALIZATION] = SSERV_CMD_EDIT_CURRENT_PROB,
