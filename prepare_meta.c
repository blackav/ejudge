...
static struct meta_info_item meta_info_section_global_data_data[] =
{
  ...
  [CNTSGLOB_show_problems_link_before_start] = { CNTSGLOB_show_problems_link_before_start, 'B', XSIZE(struct section_global_data, show_problems_link_before_start), "show_problems_link_before_start", XOFFSET(struct section_global_data, show_problems_link_before_start) },
  [CNTSGLOB_show_problems_link_after_finish] = { CNTSGLOB_show_problems_link_after_finish, 'B', XSIZE(struct section_global_data, show_problems_link_after_finish), "show_problems_link_after_finish", XOFFSET(struct section_global_data, show_problems_link_after_finish) },
...
static struct meta_info_item meta_info_section_problem_data_data[] =
{
  ...
  [CNTSPROB__pad1] = { CNTSPROB__pad1, 'S', XSIZE(struct section_problem_data, _pad1), "_pad1", XOFFSET(struct section_problem_data, _pad1) },
