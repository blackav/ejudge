...
static struct meta_info_item meta_info_section_problem_data_data[] =
{
  ...
  [CNTSPROB_enable_submit_after_reject] = { CNTSPROB_enable_submit_after_reject, 'B', XSIZE(struct section_problem_data, enable_submit_after_reject), "enable_submit_after_reject", XOFFSET(struct section_problem_data, enable_submit_after_reject) },
