...
static struct meta_info_item meta_info_section_global_data_data[] =
{
  ...
  [SGLOB_variant_map] = { SGLOB_variant_map, '?', XSIZE(struct section_global_data, variant_map), NULL, XOFFSET(struct section_global_data, variant_map) },
  ...
  [SGLOB_user_adjustment_info] = { SGLOB_user_adjustment_info, '?', XSIZE(struct section_global_data, user_adjustment_info), NULL, XOFFSET(struct section_global_data, user_adjustment_info) },
  [SGLOB_user_adjustment_map] = { SGLOB_user_adjustment_map, '?', XSIZE(struct section_global_data, user_adjustment_map), NULL, XOFFSET(struct section_global_data, user_adjustment_map) },
...
static struct meta_info_item meta_info_section_problem_data_data[] =
{
  ...
  [SPROB_abstract] = { SPROB_abstract, 'B', XSIZE(struct section_problem_data, abstract), "abstract", XOFFSET(struct section_problem_data, abstract) },
  [SPROB_type_val] = { SPROB_type_val, 'i', XSIZE(struct section_problem_data, type_val), NULL, XOFFSET(struct section_problem_data, type_val) },
  [SPROB_manual_checking] = { SPROB_manual_checking, 'B', XSIZE(struct section_problem_data, manual_checking), "manual_checking", XOFFSET(struct section_problem_data, manual_checking) },
  ...
  [SPROB_check_presentation] = { SPROB_check_presentation, 'B', XSIZE(struct section_problem_data, check_presentation), "check_presentation", XOFFSET(struct section_problem_data, check_presentation) },
  [SPROB_scoring_checker] = { SPROB_scoring_checker, 'B', XSIZE(struct section_problem_data, scoring_checker), "scoring_checker", XOFFSET(struct section_problem_data, scoring_checker) },
  [SPROB_use_stdin] = { SPROB_use_stdin, 'B', XSIZE(struct section_problem_data, use_stdin), "use_stdin", XOFFSET(struct section_problem_data, use_stdin) },
  [SPROB_use_stdout] = { SPROB_use_stdout, 'B', XSIZE(struct section_problem_data, use_stdout), "use_stdout", XOFFSET(struct section_problem_data, use_stdout) },
  [SPROB_binary_input] = { SPROB_binary_input, 'B', XSIZE(struct section_problem_data, binary_input), "binary_input", XOFFSET(struct section_problem_data, binary_input) },
  [SPROB_ignore_exit_code] = { SPROB_ignore_exit_code, 'B', XSIZE(struct section_problem_data, ignore_exit_code), "ignore_exit_code", XOFFSET(struct section_problem_data, ignore_exit_code) },
  [SPROB_olympiad_mode] = { SPROB_olympiad_mode, 'B', XSIZE(struct section_problem_data, olympiad_mode), "olympiad_mode", XOFFSET(struct section_problem_data, olympiad_mode) },
  [SPROB_score_latest] = { SPROB_score_latest, 'B', XSIZE(struct section_problem_data, score_latest), "score_latest", XOFFSET(struct section_problem_data, score_latest) },
  ...
  [SPROB_use_ac_not_ok] = { SPROB_use_ac_not_ok, 'B', XSIZE(struct section_problem_data, use_ac_not_ok), "use_ac_not_ok", XOFFSET(struct section_problem_data, use_ac_not_ok) },
  [SPROB_team_enable_rep_view] = { SPROB_team_enable_rep_view, 'B', XSIZE(struct section_problem_data, team_enable_rep_view), "team_enable_rep_view", XOFFSET(struct section_problem_data, team_enable_rep_view) },
  [SPROB_team_enable_ce_view] = { SPROB_team_enable_ce_view, 'B', XSIZE(struct section_problem_data, team_enable_ce_view), "team_enable_ce_view", XOFFSET(struct section_problem_data, team_enable_ce_view) },
  [SPROB_team_show_judge_report] = { SPROB_team_show_judge_report, 'B', XSIZE(struct section_problem_data, team_show_judge_report), "team_show_judge_report", XOFFSET(struct section_problem_data, team_show_judge_report) },
  [SPROB_ignore_compile_errors] = { SPROB_ignore_compile_errors, 'B', XSIZE(struct section_problem_data, ignore_compile_errors), "ignore_compile_errors", XOFFSET(struct section_problem_data, ignore_compile_errors) },
  ...
  [SPROB_variable_full_score] = { SPROB_variable_full_score, 'B', XSIZE(struct section_problem_data, variable_full_score), "variable_full_score", XOFFSET(struct section_problem_data, variable_full_score) },
  ...
  [SPROB_ignore_penalty] = { SPROB_ignore_penalty, 'B', XSIZE(struct section_problem_data, ignore_penalty), "ignore_penalty", XOFFSET(struct section_problem_data, ignore_penalty) },
  [SPROB_use_corr] = { SPROB_use_corr, 'B', XSIZE(struct section_problem_data, use_corr), "use_corr", XOFFSET(struct section_problem_data, use_corr) },
  [SPROB_use_info] = { SPROB_use_info, 'B', XSIZE(struct section_problem_data, use_info), "use_info", XOFFSET(struct section_problem_data, use_info) },
  [SPROB_use_tgz] = { SPROB_use_tgz, 'B', XSIZE(struct section_problem_data, use_tgz), "use_tgz", XOFFSET(struct section_problem_data, use_tgz) },
  [SPROB_tests_to_accept] = { SPROB_tests_to_accept, 'B', XSIZE(struct section_problem_data, tests_to_accept), "tests_to_accept", XOFFSET(struct section_problem_data, tests_to_accept) },
  [SPROB_accept_partial] = { SPROB_accept_partial, 'B', XSIZE(struct section_problem_data, accept_partial), "accept_partial", XOFFSET(struct section_problem_data, accept_partial) },
  ...
  [SPROB_disable_user_submit] = { SPROB_disable_user_submit, 'B', XSIZE(struct section_problem_data, disable_user_submit), "disable_user_submit", XOFFSET(struct section_problem_data, disable_user_submit) },
  [SPROB_disable_tab] = { SPROB_disable_tab, 'B', XSIZE(struct section_problem_data, disable_tab), "disable_tab", XOFFSET(struct section_problem_data, disable_tab) },
  [SPROB_restricted_statement] = { SPROB_restricted_statement, 'B', XSIZE(struct section_problem_data, restricted_statement), "restricted_statement", XOFFSET(struct section_problem_data, restricted_statement) },
  [SPROB_disable_submit_after_ok] = { SPROB_disable_submit_after_ok, 'B', XSIZE(struct section_problem_data, disable_submit_after_ok), "disable_submit_after_ok", XOFFSET(struct section_problem_data, disable_submit_after_ok) },
  [SPROB_disable_auto_testing] = { SPROB_disable_auto_testing, 'B', XSIZE(struct section_problem_data, disable_auto_testing), "disable_auto_testing", XOFFSET(struct section_problem_data, disable_auto_testing) },
  [SPROB_disable_testing] = { SPROB_disable_testing, 'B', XSIZE(struct section_problem_data, disable_testing), "disable_testing", XOFFSET(struct section_problem_data, disable_testing) },
  [SPROB_enable_compilation] = { SPROB_enable_compilation, 'B', XSIZE(struct section_problem_data, enable_compilation), "enable_compilation", XOFFSET(struct section_problem_data, enable_compilation) },
  [SPROB_skip_testing] = { SPROB_skip_testing, 'B', XSIZE(struct section_problem_data, skip_testing), "skip_testing", XOFFSET(struct section_problem_data, skip_testing) },
  [SPROB_hidden] = { SPROB_hidden, 'B', XSIZE(struct section_problem_data, hidden), "hidden", XOFFSET(struct section_problem_data, hidden) },
  ...
  [SPROB_stand_hide_time] = { SPROB_stand_hide_time, 'B', XSIZE(struct section_problem_data, stand_hide_time), "stand_hide_time", XOFFSET(struct section_problem_data, stand_hide_time) },
  ...
  [SPROB_advance_to_next] = { SPROB_advance_to_next, 'B', XSIZE(struct section_problem_data, advance_to_next), "advance_to_next", XOFFSET(struct section_problem_data, advance_to_next) },
  [SPROB_enable_text_form] = { SPROB_enable_text_form, 'B', XSIZE(struct section_problem_data, enable_text_form), "enable_text_form", XOFFSET(struct section_problem_data, enable_text_form) },
  [SPROB_stand_ignore_score] = { SPROB_stand_ignore_score, 'B', XSIZE(struct section_problem_data, stand_ignore_score), "stand_ignore_score", XOFFSET(struct section_problem_data, stand_ignore_score) },
  [SPROB_stand_last_column] = { SPROB_stand_last_column, 'B', XSIZE(struct section_problem_data, stand_last_column), "stand_last_column", XOFFSET(struct section_problem_data, stand_last_column) },
  [SPROB_disable_security] = { SPROB_disable_security, 'B', XSIZE(struct section_problem_data, disable_security), "disable_security", XOFFSET(struct section_problem_data, disable_security) },
  ...
  [SPROB_ntests] = { SPROB_ntests, 'i', XSIZE(struct section_problem_data, ntests), NULL, XOFFSET(struct section_problem_data, ntests) },
  [SPROB_tscores] = { SPROB_tscores, '?', XSIZE(struct section_problem_data, tscores), NULL, XOFFSET(struct section_problem_data, tscores) },
  [SPROB_x_score_tests] = { SPROB_x_score_tests, '?', XSIZE(struct section_problem_data, x_score_tests), NULL, XOFFSET(struct section_problem_data, x_score_tests) },
  ...
  [SPROB_ts_total] = { SPROB_ts_total, 'i', XSIZE(struct section_problem_data, ts_total), NULL, XOFFSET(struct section_problem_data, ts_total) },
  [SPROB_ts_infos] = { SPROB_ts_infos, '?', XSIZE(struct section_problem_data, ts_infos), NULL, XOFFSET(struct section_problem_data, ts_infos) },
  ...
  [SPROB_t_deadline] = { SPROB_t_deadline, 't', XSIZE(struct section_problem_data, t_deadline), NULL, XOFFSET(struct section_problem_data, t_deadline) },
  ...
  [SPROB_t_start_date] = { SPROB_t_start_date, 't', XSIZE(struct section_problem_data, t_start_date), NULL, XOFFSET(struct section_problem_data, t_start_date) },
  ...
  [SPROB_dp_total] = { SPROB_dp_total, 'i', XSIZE(struct section_problem_data, dp_total), NULL, XOFFSET(struct section_problem_data, dp_total) },
  [SPROB_dp_infos] = { SPROB_dp_infos, '?', XSIZE(struct section_problem_data, dp_infos), NULL, XOFFSET(struct section_problem_data, dp_infos) },
  ...
  [SPROB_pd_total] = { SPROB_pd_total, 'i', XSIZE(struct section_problem_data, pd_total), NULL, XOFFSET(struct section_problem_data, pd_total) },
  [SPROB_pd_infos] = { SPROB_pd_infos, '?', XSIZE(struct section_problem_data, pd_infos), NULL, XOFFSET(struct section_problem_data, pd_infos) },
  ...
  [SPROB_score_bonus_total] = { SPROB_score_bonus_total, 'i', XSIZE(struct section_problem_data, score_bonus_total), NULL, XOFFSET(struct section_problem_data, score_bonus_total) },
  [SPROB_score_bonus_val] = { SPROB_score_bonus_val, '?', XSIZE(struct section_problem_data, score_bonus_val), NULL, XOFFSET(struct section_problem_data, score_bonus_val) },
  ...
  [SPROB_unhandled_vars] = { SPROB_unhandled_vars, 's', XSIZE(struct section_problem_data, unhandled_vars), NULL, XOFFSET(struct section_problem_data, unhandled_vars) },
  ...
  [SPROB_score_view_score] = { SPROB_score_view_score, '?', XSIZE(struct section_problem_data, score_view_score), NULL, XOFFSET(struct section_problem_data, score_view_score) },
...
static struct meta_info_item meta_info_section_language_data_data[] =
{
  ...
  [SLANG_disabled] = { SLANG_disabled, 'B', XSIZE(struct section_language_data, disabled), "disabled", XOFFSET(struct section_language_data, disabled) },
  ...
  [SLANG_binary] = { SLANG_binary, 'B', XSIZE(struct section_language_data, binary), "binary", XOFFSET(struct section_language_data, binary) },
  ...
  [SLANG_insecure] = { SLANG_insecure, 'B', XSIZE(struct section_language_data, insecure), "insecure", XOFFSET(struct section_language_data, insecure) },
  ...
  [SLANG_disable_auto_testing] = { SLANG_disable_auto_testing, 'B', XSIZE(struct section_language_data, disable_auto_testing), "disable_auto_testing", XOFFSET(struct section_language_data, disable_auto_testing) },
  [SLANG_disable_testing] = { SLANG_disable_testing, 'B', XSIZE(struct section_language_data, disable_testing), "disable_testing", XOFFSET(struct section_language_data, disable_testing) },
  ...
  [SLANG_unhandled_vars] = { SLANG_unhandled_vars, 's', XSIZE(struct section_language_data, unhandled_vars), NULL, XOFFSET(struct section_language_data, unhandled_vars) },
  [SLANG_disabled_by_config] = { SLANG_disabled_by_config, 'i', XSIZE(struct section_language_data, disabled_by_config), NULL, XOFFSET(struct section_language_data, disabled_by_config) },
};
...
static struct meta_info_item meta_info_section_tester_data_data[] =
{
  ...
  [STESTER_any] = { STESTER_any, 'B', XSIZE(struct section_tester_data, any), "any", XOFFSET(struct section_tester_data, any) },
  [STESTER_is_dos] = { STESTER_is_dos, 'B', XSIZE(struct section_tester_data, is_dos), "is_dos", XOFFSET(struct section_tester_data, is_dos) },
  [STESTER_no_redirect] = { STESTER_no_redirect, 'B', XSIZE(struct section_tester_data, no_redirect), "no_redirect", XOFFSET(struct section_tester_data, no_redirect) },
  ...
  [STESTER_ignore_stderr] = { STESTER_ignore_stderr, 'B', XSIZE(struct section_tester_data, ignore_stderr), "ignore_stderr", XOFFSET(struct section_tester_data, ignore_stderr) },
  ...
  [STESTER_abstract] = { STESTER_abstract, 'B', XSIZE(struct section_tester_data, abstract), "abstract", XOFFSET(struct section_tester_data, abstract) },
  [STESTER_super] = { STESTER_super, 'x', XSIZE(struct section_tester_data, super), "super", XOFFSET(struct section_tester_data, super) },
  [STESTER_is_processed] = { STESTER_is_processed, 'B', XSIZE(struct section_tester_data, is_processed), NULL, XOFFSET(struct section_tester_data, is_processed) },
  [STESTER_skip_testing] = { STESTER_skip_testing, 'B', XSIZE(struct section_tester_data, skip_testing), "skip_testing", XOFFSET(struct section_tester_data, skip_testing) },
  [STESTER_no_core_dump] = { STESTER_no_core_dump, 'B', XSIZE(struct section_tester_data, no_core_dump), "no_core_dump", XOFFSET(struct section_tester_data, no_core_dump) },
  [STESTER_enable_memory_limit_error] = { STESTER_enable_memory_limit_error, 'B', XSIZE(struct section_tester_data, enable_memory_limit_error), "enable_memory_limit_error", XOFFSET(struct section_tester_data, enable_memory_limit_error) },
  ...
  [STESTER_clear_env] = { STESTER_clear_env, 'B', XSIZE(struct section_tester_data, clear_env), "clear_env", XOFFSET(struct section_tester_data, clear_env) },
  ...
  [STESTER_standard_checker_used] = { STESTER_standard_checker_used, 'i', XSIZE(struct section_tester_data, standard_checker_used), NULL, XOFFSET(struct section_tester_data, standard_checker_used) },
  [STESTER_memory_limit_type_val] = { STESTER_memory_limit_type_val, 'i', XSIZE(struct section_tester_data, memory_limit_type_val), NULL, XOFFSET(struct section_tester_data, memory_limit_type_val) },
  [STESTER_secure_exec_type_val] = { STESTER_secure_exec_type_val, 'i', XSIZE(struct section_tester_data, secure_exec_type_val), NULL, XOFFSET(struct section_tester_data, secure_exec_type_val) },
};
