...
static struct meta_info_item meta_info_section_global_data_data[] =
{
  ...
  [CNTSGLOB_unhandled_vars] = { CNTSGLOB_unhandled_vars, 's', XSIZE(struct section_global_data, unhandled_vars), NULL, XOFFSET(struct section_global_data, unhandled_vars) },
...
static struct meta_info_item meta_info_section_problem_data_data[] =
{
  ...
  [CNTSPROB_unhandled_vars] = { CNTSPROB_unhandled_vars, 's', XSIZE(struct section_problem_data, unhandled_vars), NULL, XOFFSET(struct section_problem_data, unhandled_vars) },
...
static struct meta_info_item meta_info_section_language_data_data[] =
{
  ...
  [CNTSLANG_unhandled_vars] = { CNTSLANG_unhandled_vars, 's', XSIZE(struct section_language_data, unhandled_vars), NULL, XOFFSET(struct section_language_data, unhandled_vars) },
