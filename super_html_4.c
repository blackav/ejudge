...
static const int external_action_aliases[SSERV_CMD_LAST] =
{
  ...
  [SSERV_CMD_EDIT_USERS_ACCESS_PAGE] = SSERV_CMD_EDIT_REGISTER_ACCESS_PAGE,
  [SSERV_CMD_EDIT_MASTER_ACCESS_PAGE] = SSERV_CMD_EDIT_REGISTER_ACCESS_PAGE,
  [SSERV_CMD_EDIT_JUDGE_ACCESS_PAGE] = SSERV_CMD_EDIT_REGISTER_ACCESS_PAGE,
  [SSERV_CMD_EDIT_TEAM_ACCESS_PAGE] = SSERV_CMD_EDIT_REGISTER_ACCESS_PAGE,
  [SSERV_CMD_EDIT_SERVE_CONTROL_ACCESS_PAGE] = SSERV_CMD_EDIT_REGISTER_ACCESS_PAGE,
  [SSERV_CMD_NEW_CNTS_EDIT_RESERVE_FIELDS_PAGE] = SSERV_CMD_NEW_CNTS_EDIT_CONTESTANT_FIELDS_PAGE,
  [SSERV_CMD_NEW_CNTS_EDIT_COACH_FIELDS_PAGE] = SSERV_CMD_NEW_CNTS_EDIT_CONTESTANT_FIELDS_PAGE,
  [SSERV_CMD_NEW_CNTS_EDIT_ADVISOR_FIELDS_PAGE] = SSERV_CMD_NEW_CNTS_EDIT_CONTESTANT_FIELDS_PAGE,
  [SSERV_CMD_NEW_CNTS_EDIT_GUEST_FIELDS_PAGE] = SSERV_CMD_NEW_CNTS_EDIT_CONTESTANT_FIELDS_PAGE,
};
static const unsigned char * const external_action_names[SSERV_CMD_LAST] =
{
  ...
  [SSERV_CMD_EDIT_REGISTER_ACCESS_PAGE] = "cnts_edit_access_page",
  [SSERV_CMD_EDIT_USER_FIELDS_PAGE] = "cnts_edit_user_fields_page",
  [SSERV_CMD_NEW_CNTS_EDIT_CONTESTANT_FIELDS_PAGE] = "cnts_edit_member_fields_page",
};
